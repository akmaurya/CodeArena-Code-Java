package com.xcode.javas.zedsoftware.swing.popup;
...
class popup extends JFrame implements ActionListener
{
    ...
    public popup()
    {
        ...
        findPane.add(findLabel);
            ...
            findWhat.setBounds(10,30,70,20);
            findPane.add(findWhat);

                findWhatTF=new JTextField();
                findWhatTF.setBounds(100,30,335,30);
                findPane.add(findWhatTF);

                    findBT=new JButton("Find");
                    findBT.setBounds(100,70,100,30);
                    findPane.add(findBT);
            ...
            findPane.add(replaceWith);
                ...
                replaceWithTF.setBounds(100,130,335,30);
                findPane.add(replaceWithTF);

                    replaceBT=new JButton("Replace");
                    replaceBT.setBounds(100,170,100,30);
