...
import com.src.java.testables.Rectangle;
...
public class RectangleTest {
	...
	public void test1() {
		...
		assertTrue("Test 1: Default values are wrong.", r.getH() == 0 && r.getW() == 0);
	...
	public void test2() {
		...
		r = new Rectangle();
		try {
			assertTrue("Test 2: Default values are wrong.", r.getH() == 0 && r.getW() == 0 && r.getA() == 0);
	...
	public void test3() {
		...
		try {
			...
			assertTrue("Test 3: Initial values are wrong.", r.getH() == 10 && r.getW() == 20 && r.getA() == 200);
	...
	public void test4() {
		...
		try {
			for (int i = 0; i < 5; i++) {
				...
				assertTrue("Test 4: Initial values are wrong.", rList[i].getH() == 2 * i && rList[i].getW() == 3 * i
						&& rList[i].getA() == 6 * i * i);
			}
	...
	public void test5() {
		...
		try {
			for (int i = 0; i < 5; i++) {
				...
				rList[i].setH(11 * i);
				rList[i].setW(7 * i);
				assertTrue("Test 5: Modified values are wrong.", rList[i].getH() == 11 * i && rList[i].getW() == 7 * i
						&& rList[i].getA() == 77 * i * i);
			}
	...
	public void test6() {
		...
		try {
			for (int i = 0; i < 5; i++) {
				...
				rList[i].setH(11 * i);
				rList[i].setW(7 * i);
				assertTrue("Test 6: Modified values are wrong.", rList[i].getH() == 11 * i && rList[i].getW() == 7 * i
						&& rList[i].getA() == 77 * i * i);
	...
	public static void main(String[] args) {
		org.junit.runner.JUnitCore.main("com.src.java.testables.junit.RectangleTest");
	}
