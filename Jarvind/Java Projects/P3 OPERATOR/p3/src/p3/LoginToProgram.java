				...
				if(str1.equals(log.getText()))
				{
					...
					if(str2.equals(pws.getText()))
					{
						...
						{	
							...
							dg.dispose();
                                                        System.out.println("finyear="+finyear+";"+log.getText()+";"+cbLog.getSelectedIndex());
							MR=new MasterScreen(log.getText(),cbLog.getSelectedIndex(),"","");
                                                        System.out.println("finyear1="+finyear);
							LoginToProgram.MR.setTitle("ABC Ver 1.1 :: Running Financial Year # "+finyear.substring(0,2)+"-"+finyear.substring(2,4));
                                                        System.out.println("finyear2="+finyear);
							//String getT=LoginToProgram.MR.getTitle();
                                                        System.out.println("finyear3="+finyear);
                                                          
                                                          
                                                         
							Main.year=finyear;
                                                        javax.swing.JOptionPane.showMessageDialog(null,"Correct"+Main.year);
