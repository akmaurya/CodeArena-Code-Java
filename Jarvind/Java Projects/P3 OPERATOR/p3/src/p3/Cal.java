...
public class Cal implements KeyListener,MouseListener,ActionListener
{
	...
	public Cal()
	{
		...
		jd.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
...
//..........................................
		...
		if(date.getDate()<=holddata)
                ...
                /*else
                {
                    if(date.getDate()==30 && holddata==1)
                    setdate(29);
                    else if(date.getDate() == 31 && holddata == 2)
                    setdate(30);
                }*/
...
//........................................................................		
	...
	{
            if(me.getSource()==preyear)
            {
                t1.stop();
            }
            if(me.getSource()==postyear)
            {
		 t2.stop();
            }
        }
