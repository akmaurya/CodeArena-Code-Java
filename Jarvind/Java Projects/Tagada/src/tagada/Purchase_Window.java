...
/*
 * Purchase_Window.java
 *
 * Created on Nov 20, 2012, 1:22:33 PM
 */
 ...
 * @author user2
 */
public class Purchase_Window extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(tagada.TagadaApp.class).getContext().getResourceMap(Purchase_Window.class);
        ...
        jComboBox1.setBounds(170, 20, 380, 30);
        ...
        jPanel1.add(jLabel5);
        jLabel5.setBounds(320, 65, 60, 30);
        ...
        jPanel1.add(jLabel6);
        jLabel6.setBounds(390, 65, 120, 30);
        ...
        jTextField1.setBounds(170, 65, 120, 30);

        jLabel2.setFont(resourceMap.getFont("jLabel1.font")); // NOI18N
        jLabel2.setText(resourceMap.getString("jLabel2.text")); // NOI18N
        jLabel2.setName("jLabel2"); // NOI18N
        jPanel1.add(jLabel2);
        jLabel2.setBounds(10, 65, 90, 30);
        ...
        jButton1.setBounds(520, 65, 30, 30);
        ...
        jButton3.setBounds(170, 110, 120, 35);
        ...
        jButton4.setBounds(430, 110, 120, 35);
        ...
        jButton5.setBounds(300, 110, 120, 35);

        getContentPane().add(jPanel1);
        jPanel1.setBounds(10, 20, 560, 150);
        ...
        jScrollPane1.setBounds(10, 10, 350, 450);

        getContentPane().add(jPanel2);
        jPanel2.setBounds(580, 20, 370, 470);

        jLabel3.setIcon(resourceMap.getIcon("jLabel3.icon")); // NOI18N
        jLabel3.setText(resourceMap.getString("jLabel3.text")); // NOI18N
        jLabel3.setName("jLabel3"); // NOI18N
        getContentPane().add(jLabel3);
        jLabel3.setBounds(10, 180, 560, 310);
...
private void loadInitialInfo()
{
    ...
    try
    {
        qry="Select party_name from purchase_Party_Master order by party_name";
...
public boolean Save()
{
    ...
    {
        int ind=0;
        qry="Select max(purchase_code) from purchase_Detail";
        ...
        qry="insert into purchase_Detail values("+ind+",'"+jComboBox1.getSelectedItem().toString()+"',"+Double.valueOf(jTextField1.getText().trim())+",#"+setDate+"#)";
        boolean bn=Utility.saveInformation(qry);

        qry="select credit from party_Account where party_name='"+jComboBox1.getSelectedItem().toString()+"'";
        String getCreditAmont=Utility.getSingleValue(qry);
        if(getCreditAmont!=null)
        {
            double totalCreditAmt=Double.valueOf(getCreditAmont)+Double.valueOf(jTextField1.getText().trim());
            qry="update party_Account set credit="+totalCreditAmt+" where party_name='"+jComboBox1.getSelectedItem().toString()+"'";
...
private void uploadDetail()
{
    ...
    try
    {
            qry="select * from purchase_Detail";
...
private void deleteItem()
{
    ...
    try
    {
        ...
        else if(dtm.getRowCount() > 0)
        {
            ...
            {
                qry="delete * from purchase_Detail where party_name='"+jTable1.getValueAt(jTable1.getSelectedRow(), 1)+"'";
...
private void updatePurchase()
{
    ...
    else if(dtm.getRowCount() > 0)
    {
        ...
        {
            int c=javax.swing.JOptionPane.showConfirmDialog(this, "Are you sure you want to update this Purchase Detail?", "Update Purchase Detail", javax.swing.JOptionPane.YES_NO_OPTION);
            if(c==javax.swing.JOptionPane.YES_OPTION)
            {
                ...
                qry="update purchase_Detail set party_name='"+jComboBox1.getSelectedItem().toString()+"', amount="+Double.valueOf(jTextField1.getText().trim())+", purchase_date=#"+setDate+"# where party_name='"+(""+jTable1.getValueAt(jTable1.getSelectedRow(), 1))+"'";
                Utility.saveInformation(qry);
