...
/*
 * Create_Purchase_Party.java
 *
 * Created on Nov 19, 2012, 6:08:28 PM
 */
 ...
 * @author user2
 */
public class Create_Purchase_Party extends javax.swing.JInternalFrame {
    Color cl1=new Color(232,232,164);
    Color cl3=new Color(255,255,204);

    /** Creates new form Create_Purchase_Party */
    public Create_Purchase_Party() {
        initComponents();
        ...
        String heading1[]={"S.No.","Purchase Party Name","Address","Contact No."};
        ...
        column=jTable1.getColumn("Purchase Party Name");
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(tagada.TagadaApp.class).getContext().getResourceMap(Create_Purchase_Party.class);
        ...
        jPanel1.add(jLabel1);
        jLabel1.setBounds(20, 20, 175, 30);
        ...
        jTextField1.setBounds(270, 20, 470, 30);
        ...
        jTextField3.setBounds(600, 65, 140, 30);

        getContentPane().add(jPanel1);
        jPanel1.setBounds(10, 10, 760, 120);
        ...
        jPanel2.setBounds(10, 200, 760, 400);
        ...
        jButton3.setBounds(280, 150, 150, 35);
        ...
        jButton1.setBounds(620, 150, 150, 35);
        ...
        jButton4.setBounds(450, 150, 150, 35);
...
private void loadInitialInfo()
{
    ...
    {
         String arr[]=null;
       qry="Select * from purchase_Party_Master order by party_name";
...
boolean Save()
{
    ...
    try
    {
        ...
        qry="select party_name from  purchase_Party_Master where party_name='"+jTextField1.getText().trim()+"'";
        String getName=Utility.getSingleValue(qry);
        if(getName.length()>0)
        {
            javax.swing.JOptionPane.showMessageDialog(null,"Sorry! The Purchase Party already exists.");
        ...
        else
        {
            ...
            qry="insert into purchase_Party_Master values('"+jTextField1.getText().trim()+"','"+jTextField2.getText().trim()+"','"+jTextField3.getText().trim()+"')";
...
private void uploadDetail()
{
    ...
    try
    {
            qry="Select party_name,address,phone from purchase_Party_Master order by party_name asc";
            String load[][]=Utility.getInformationDD(qry, 3);
            String arr[]=null;
            if(load.length>0)
            {
...
private void deletePurchaseParty()
{
    String qry="";
    ...
    try
    {
        ...
        else if(dtm.getRowCount() > 0)
        {
            ...
            {
                qry="delete * from purchase_Party_Master where party_name='"+jTable1.getValueAt(jTable1.getSelectedRow(), 1)+"'";
...
private void updatePurchase()
{
    ...
    else if(dtm.getRowCount() > 0)
    {
        ...
        qry="select party_name from purchase_Party_Master where party_name='"+(jTextField1.getText())+"'";
        ...
        {
            int c=javax.swing.JOptionPane.showConfirmDialog(this, "Are you sure you want to update this Purchase Party?", "Update Purchase Party", javax.swing.JOptionPane.YES_NO_OPTION);
            if(c==javax.swing.JOptionPane.YES_OPTION)
            {
                qry="update purchase_Party_Master set party_name='"+jTextField1.getText().trim()+"', address='"+jTextField2.getText().trim()+"', phone='"+jTextField3.getText().trim()+"' where party_name='"+(""+jTable1.getValueAt(jTable1.getSelectedRow(), 1))+"'";
                Utility.saveInformation(qry);

                dtm.setRowCount(0);
                uploadDetail();

                javax.swing.JOptionPane.showMessageDialog(this, "Purchase Party Updated Successfully.");
            }
        }
    }
}
