...
public class getIPaddress
{
	...
	{
		//String store=new String("rmi://127.0.0.1/ExtendZedServer");//"rmi://127.0.0.1/ExtendZedServer"
		String store=new String("rmi://127.0.0.1/atmMethods");
		try
		{
	...
	public static void changeIP()
	{
		try
		{
			...
			*/
			 ...
			 *server
			 */				
			interfaceATM inf=null;
			inf=(interfaceATM)Naming.lookup(getIPaddress.IP());
		}
		catch(Exception e)
		{
			try
			...
			String store="rmi://127.0.0.1/atmMethods";
			byte bt[]=store.getBytes();
			newraf.write(bt);
			newraf.close();
