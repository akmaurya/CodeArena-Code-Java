...
public int breakAmtUBI(int paymentno,double amt) throws java.rmi.RemoteException;
public int breakAmtKGSG(int Paymentno, double amt) throws java.rmi.RemoteException;
