...
javax.swing.table.DefaultTableModel dtm;
    ...
    public void opening()
    {
        ...
        if(data.length()>0)
        {
            qry="update polish_transaction_opening set opening="+opening+" where transaction_date=#"+setDate+"#";
            Utility.saveInformation(qry);
        }
        else
        {
            qry="insert into polish_transaction_opening values(#"+setDate+"#,"+opening+","+closing+")";
            Utility.saveInformation(qry);
 ...
 public boolean getData()
    {   dtm.setRowCount(0);
        ...
        if(load.length>0)
        {
            ...
            String setDate=d1+"-"+month+"-"+year;

            if((setDate.equals(date1))&&(setDate.equals(date2)))
            {
