 ...
 * @author user1
 */
public class Polish_Material_Opening_Stock extends javax.swing.JInternalFrame {

    /** Creates new form Opening_Stock */
    public Polish_Material_Opening_Stock(){
        initComponents();
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Opening Polish Material");
        ...
        jComboBox1.setBounds(130, 20, 250, 30);
        ...
        jLabel3.setBounds(300, 60, 80, 30);
...
public void addItem()
    ...
    public boolean add()
    {
               double newOpeningStock=Double.valueOf(jTextField1.getText());
               String selectedItem=""+jComboBox1.getSelectedItem();
               String qry="select opening,quantity from polish_material where material_name='"+selectedItem+"'";
               String[][] data=Utility.getInformationDD(qry,2);
                double oldOpeningStock=Double.valueOf(data[0][0]);
               double oldQuantity=Double.valueOf(data[0][1]);
               ...
               {
                    String qry1="update polish_material set quantity="+newQuantity+",opening="+newOpeningStock+" where material_name='"+selectedItem+"'";
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        // TODO add your handling code here:
                      ...
                      String qry1="select opening from polish_material where material_name='"+(jComboBox1.getSelectedItem())+"'";
                      ...
                      jTextField1.setText(""+bd.setScale(scale,5));
    ...
    private void jButton1ActionPerformed1(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed1
       ...
       {    if(Utility.isDouble(jTextField1.getText()))
            {           Boolean b=add();
                        if(b==true)
                        {       int check=javax.swing.JOptionPane.showConfirmDialog(this,"Record sucessfully updated.\n Do you want to continue ????????. " ,"Message Box",javax.swing.JOptionPane.YES_NO_OPTION);
                                if(check==0)
                                     {  jComboBox1.requestFocus();
                                     }
                                if(check==1)
           ...
           {
                  javax.swing.JOptionPane.showMessageDialog(this,"Error............Invalied entry of opening." ,"Message Box",javax.swing.JOptionPane.INFORMATION_MESSAGE);
           }
       }
       else
       {
              javax.swing.JOptionPane.showMessageDialog(this,"Error............ Material opening does not blank. Minimum '0' is required." ,"Message Box",javax.swing.JOptionPane.INFORMATION_MESSAGE);
       }
