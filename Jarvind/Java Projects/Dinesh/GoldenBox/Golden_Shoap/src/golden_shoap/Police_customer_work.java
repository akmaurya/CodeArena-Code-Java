...
// static int sNo=0;
    ...
    public Police_customer_work() {
        initComponents();
         ...
         dtm=new javax.swing.table.DefaultTableModel();
            ...
            jComboBox2.setSelectedItem("SONARI");
    ...
    private void initComponents() {
        ...
        jComboBox1.setBounds(290, 20, 180, 23);
        ...
        jComboBox2.setBounds(300, 80, 180, 23);
        ...
        jComboBox3.setBounds(570, 80, 120, 23);
        ...
        jLabel10.setBounds(610, 20, 90, 23);
        ...
        jLabel15.setBounds(490, 80, 80, 23);
        ...
        jTextField8.setBounds(180, 20, 100, 23);
        ...
        jButton7.setBounds(470, 20, 25, 25);
    ...
    {
                      String qry="select item_name from item_master order by item_name "  ;
                      String[][] data=Utility.getInformationDD(qry,1);
          ...
          if((dtm.getRowCount())>0)
           {                      //    System.out.println("dtm.getRowCount())="+dtm.getRowCount());
                                      ...
                                      {          //Deliver Date (it store unvalied data (used only for formality)
                                              ...
                                              System.out.println("Hiiiiiiiiiiiiiiiiiii2");
                                      }
                                 ...
                                 if(check==javax.swing.JOptionPane.YES_OPTION)
                                 {
                                    ...
                                    jTable1.setValueAt((""+jLabel8.getText()), row, 9);
                                                 ...
                                                 else
                                                 {
                                                                     ...
                                                                     //to manage amount when user update (Before polish/ After polish)
                                                                     if(jComboBox6.getSelectedItem().equals("After Polish"))
                                                                     {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
       ...
       if(b==true)
       {     int purjaNumber=Integer.parseInt(""+jLabel11.getText());
             System.out.println("Purja Number%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%"+purjaNumber);
             int check=javax.swing.JOptionPane.showConfirmDialog(this,"Record sucessfully save.Do you want to deliver it ?. " ,"Message Box",javax.swing.JOptionPane.YES_NO_OPTION);
             if(check==0)
             {      System.out.println("%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%");
