...
// static int sNo=0;
    ...
    private void initComponents() {
        ...
        jPanel1.setBounds(380, 320, 360, 170);
        ...
        jTextField5.setBounds(900, 390, 100, 22);
        ...
        jLabel27.setBounds(760, 470, 130, 22);
        ...
        jLabel5.setBounds(0, 0, 1030, 520);
   ...
   public void edetingTotal()
    {
         ...
         for(int i=0;i<count1;i++)
         {
          ...
          if(oldPayableAmount!=(payableAmount-discount))
          {
                      ...
                      bd4=new java.math.BigDecimal((payableAmount-discount)-(Double.valueOf(jTextField2.getText())+Double.valueOf(jLabel7.getText())));
  ...
  {                         String qry="Select paid_at_receive from polish_details where purja_number="+gPurjaNumber+"";
                            ...
                            {
                                bd4=new java.math.BigDecimal(payableAmount-paidAtReceive);
                                jTextField7.setText(""+bd4.setScale(2,5));
                                jTextField2.setText("0.00");
                            }
                            else
                            {   voucherAmount=Double.valueOf(data);
                                ...
                                jTextField7.setText(""+(payableAmount-(paidAtReceive+(Double.valueOf(jTextField2.getText())))));
   ...
   public boolean Update()
   {
              ...
              for(int i=0;i<row;i++)
              {
                  //insert checkBox item value if checkbox is selected insert 3 in status else 2;
                      ...
                      qry="insert into polish_details values(#"+date+"#,"+purjaNumber+","+accountCode+",'"+itemName+"','"+polishType+"',"+quantity+",'"+quantityUnit+"',"+weight+",'"+weightUnit+"',"+weightAfterPolish+","+rate+",'"+rateUnit+"','"+paymentApply+"',"+amount+","+status+","+(Double.valueOf(jTextField5.getText()))+","+(Double.valueOf(jTextField6.getText()))+","+paidAtReceive+","+discountAtReceive+",'"+cancle+"',"+quantityAfterPolish+")";
                      bn=Utility.saveInformation(qry);
                      if(bn==false)
                      {
                          return false;
    ...
    private void jTextField5KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField5KeyReleased
        // TODO add your handling code here:
               ...
               //to manage paid amount
                  ...
                  //double oldPayableAmount=Double.valueOf(jLabel26.getText());
                  //if(oldPayableAmount!=(payableAmount))
                  //{
                      String qry="Select distinct paid_at_receive from polish_details where purja_number="+gPurjaNumber+"";
                      double paidAtReceive=Double.valueOf(Utility.getSingleValue(qry));
                      java.math.BigDecimal bd4=new java.math.BigDecimal((payableAmount)-(paidAtReceive+(Double.valueOf(jTextField2.getText()))));
