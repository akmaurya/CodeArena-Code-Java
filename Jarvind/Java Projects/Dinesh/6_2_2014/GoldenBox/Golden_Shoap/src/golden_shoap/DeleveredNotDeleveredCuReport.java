...
javax.swing.table.DefaultTableModel dtm;
    ...
    public DeleveredNotDeleveredCuReport() {
        ...
        java.util.Date dt=new java.util.Date();
            ...
            String heading1[]={"S.N","Rate Apply","Item Name","Polish Type","Quantity","Unit","Weight Bf/P","Unit","Weight Af/P","Quantity Af/P","Rate","Unit","Amount","Status"};
    ...
    private void initComponents() {
        ...
        jComboBox1.setBounds(140, 20, 320, 25);
        ...
        jButton7.setBounds(460, 20, 25, 25);
...
{       dtm.setRowCount(0);
        ...
        qry="Select distinct purja_number from polish_details where rec_date>=#"+date1+"# and rec_date<=#"+date2+"# and ac_code="+accountCode+" order by purja_number desc";
            ...
            qry="Select distinct purja_number from polish_details where rec_date>=#"+date1+"# and rec_date<=#"+date2+"# and ac_code="+accountCode+" and status="+deliSt+" order by purja_number desc";
        //String load[]=Utility.getResultSetAs_1D_Array(qry);
         int purjaNumber=Integer.parseInt(Utility.getSingleValue(qry));

         dtm.setRowCount(0);
       int count=0;
       qry="Select * from polish_details where purja_number="+purjaNumber+"";
