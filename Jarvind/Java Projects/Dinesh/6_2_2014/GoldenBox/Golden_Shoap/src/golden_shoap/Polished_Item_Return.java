 ...
 * @author user1
 */
public class Polished_Item_Return extends javax.swing.JInternalFrame {
  javax.swing.table.DefaultTableModel dtm;
 static int purjaNumber;

    /** Creates new form Polished_Item_Return */
    public Polished_Item_Return() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setBackground(new java.awt.Color(226, 226, 254));
        ...
        jLabel2.setBackground(new java.awt.Color(226, 226, 254));
        ...
        jLabel3.setBackground(new java.awt.Color(226, 226, 254));
        ...
        jLabel4.setBackground(new java.awt.Color(226, 226, 254));
        ...
        jLabel11.setBackground(new java.awt.Color(226, 226, 254));
        ...
        jTable1.setSelectionForeground(new java.awt.Color(116, 79, 4));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
       ...
       {    amount=Integer.parseInt(data[i][0]);
       ...
       jLabel4.setText(""+dueAmount(accountCode));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        {
        int purjaNumber=Integer.parseInt(""+jTextField1.getText());
        Purja_Details ob1=new  Purja_Details(null ,true,purjaNumber);
        ob1.setBounds(250,200,746, 420);
        ob1.setVisible(true);
        }
        catch(Exception ex)
        {
...
public void receiveItem()
{
        ...
        {
             javax.swing.JOptionPane.showMessageDialog(this,"Error... Enter valid purja number." ,"Message Box",javax.swing.JOptionPane.INFORMATION_MESSAGE);
             jTextField1.requestFocus();
        }
        else
        {
 ...
 public double dueAmount(double accountCode)
        {
               String qry1="select ac_dr,ac_cr from ac_smry where ac_code="+accountCode+"";
                           ...
                           double acDr=Integer.parseInt(data[0][0]);
                           double acCr=Integer.parseInt(data[0][1]);
...
public void loadData()
 {      int one=1;
        int zero=0;
        dtm.setRowCount(0);
        String qry="select distinct purja_number,status,ac_code from polish_details where status="+one+" or status="+zero+"";
