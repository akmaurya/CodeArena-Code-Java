 ...
 * @author user1
 */
public class Deliver_Polish_work extends javax.swing.JInternalFrame {
 javax.swing.table.DefaultTableModel dtm;
 int gPurjaNumber=0;
 //create array of checkBox;
 JCheckBox ch[]=new JCheckBox[9];

    /** Creates new form Police_customer_work */
    public Deliver_Polish_work(int purjaNumber1) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.setBounds(380, 330, 360, 170);
       ...
       try
        {       int row=jTable1.getSelectedRow();
                ...
                System.out.println("row="+row);
                    ...
                    if(totalRow==1)
                    {       
                             weight=""+(jTable1.getValueAt(row,8));
                             weight=weight.trim();
                             if(Utility.isDouble(weight))
                             {
                                rate=Double.valueOf(""+jTable1.getValueAt(0,10));
                                paymentApply=""+jTable1.getValueAt(0,1);
                    ...
                    else
                    {
                        ...
                        {    weight=""+jTable1.getValueAt(totalRow-1,8);
                             ...
                             {    
                                 ...
                                 jTable1.setValueAt("0", totalRow-1, 8);
                                 //jTable1.editCellAt(totalRow-1,8);
                ...
                if(paymentApply.equals("After Polish"))
                {
                   ...
                   //for amount
                     if((row==0))
                        {   jTable1.setValueAt(amount1, totalRow-1, 12);}
                     else
                        {jTable1.setValueAt(amount, row-1, 12);}
                }
       }
        catch(Exception ex)
       {
  ...
  {                         String qry="Select paid_at_receive from polish_details where purja_number="+gPurjaNumber+"";
                            ...
                            double netAmount=Double.valueOf(jTextField6.getText());
                            double amount=0;
                            ...
                            {
                                amount=0;
                                bd4=new java.math.BigDecimal(netAmount);
                                jTextField7.setText(""+bd4.setScale(2,5));

                            }
                            else
                            {   amount=Double.valueOf(data);
                                bd4=new java.math.BigDecimal(netAmount-paidAtReceive);
                                jTextField7.setText(""+bd4.setScale(2,5));
       ...
       if((Double.valueOf(jTextField7.getText())>0) || (Double.valueOf(jLabel7.getText())>0))
        {
                      ...
                      {       int voucherNumber=setVoucherNumber();
                              System.out.println("Total1="+totalPaidAmount);
                              ...
                              System.out.println("Total2="+totalPaidAmount);
                              if(bn==true)
                               {
                                    accountPaidAmount();
                               }
   ...
   public boolean accountPaidAmount()
  {
                 ...
                 if(Utility.isDouble(jTextField7.getText()))
                  {
                        //to find old paid amount so that subtact this amount from cr and dr and add new amount
                                             System.out.println("Hiiiiiiiiii1");
                        double oldpaidAmount=Double.valueOf(jLabel7.getText());
                                             System.out.println("Hiiiiiiiiii22");
                        //End
                        String byAccount=""+jLabel4.getText();
                        String qry="select ac_code from ac_master where ac_name='"+byAccount+"'";
                        int byAccountCode=Integer.parseInt(Utility.getSingleValue(qry));
                        ...
                        //end
                        acCr=(acCr+(Double.valueOf(""+jTextField7.getText()))+(Double.valueOf(jLabel7.getText())));
                        ...
                        //End
                        acDr=(acDr+(Double.valueOf(""+jTextField7.getText()))+(Double.valueOf(jLabel7.getText())));
    ...
    public void takeInput()
    {
         ...
         int flag=0;
         //if(purjaNumber.isEmpty()==false || purjaNumber!=null || purjaNumber.equals("null")==false)
         if(purjaNumber!=null)
         {//System.out.println("!!!!!!!!!!!!="+purjaNumber);

             if(Utility.isInteger(purjaNumber))
             {
                     String qry="select purja_number from polish_details where purja_number="+(Integer.parseInt(purjaNumber))+" and status<2";
   ...
   public boolean Update()
   {
              ...
              qry="select distinct discount_at_receive,status from polish_details where purja_number="+gPurjaNumber+"";
              String data[][]=Utility.getInformationDD(qry,2);
              double discountAtReceive=Double.valueOf(data[0][0]);
              int oldStatus=Integer.parseInt(data[0][1]);
             ...
             if((jTextField7.getText()).isEmpty() == false && (jTextField5.getText()).isEmpty() == false)
            {
                 ...
                 else if(Utility.isDouble((jTextField5.getText())) == true)
                 {
                        if(Utility.isDouble((jTextField7.getText()))==true)
                        {
                                       ...
                                       if(ReceivePaidAmount()==true && manageAccountDiscount() && Update()==true)
                                       { int check=javax.swing.JOptionPane.showConfirmDialog(this,"Record sucessfully save.\n Do you want to continue ????????. " ,"Message Box",javax.swing.JOptionPane.YES_NO_OPTION);
                                         if(check==0)
                                         {          this.dispose();
                                                    takeInput();
                                         }
       ...
       if((jTextField7.getText()).isEmpty() == false && (jTextField5.getText()).isEmpty() == false)
        {
                 ...
                 else if(Utility.isDouble((jTextField5.getText())) == true)
                 {
                        if(Utility.isDouble((jTextField7.getText()))==true)
                        {
                                       ...
                                       if(ReceivePaidAmount()==true && manageAccountDiscount() && Update()==true)
                                       { javax.swing.JOptionPane.showConfirmDialog(this,"Record sucessfully save." ,"Message Box",javax.swing.JOptionPane.YES_NO_OPTION);
    ...
    private void jTextField5KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField5KeyReleased
        // TODO add your handling code here:
          ...
          if(oldPayableAmount!=(payableAmount))
          {
                      String qry="Select distinct paid_at_receive from polish_details where purja_number="+gPurjaNumber+"";
                      double paidAtReceive=Double.valueOf(Utility.getSingleValue(qry));
                      java.math.BigDecimal bd4=new java.math.BigDecimal((payableAmount)-paidAtReceive);
                      jTextField7.setText(""+bd4.setScale(2,5));
                      //to update value of label 26
