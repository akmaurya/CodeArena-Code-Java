...
public class Purchase extends JFrame implements ActionListener,MouseListener,KeyListener,FocusListener,InternalFrameListener
{
	Container con;
	JInternalFrame frm;
	...
	JToggleButton adjustTb,depositeTb,pendingTb;
	...
	JComboBox drCrCb;
	double flag1=0,flag2=0,flag3=0,flag4=0,flag5=0,flag6=0,flag7=0,flag8=0;	
	
	public Purchase(JDesktopPane desk,int billno)
	{
		System.out.println("purchase");
		this.desk=desk;
		frm=new JInternalFrame("Purchase",false,true,false,true);
		...
		JLabel lab9=new JLabel("Old Balance Wt.(gm)",JLabel.RIGHT);
		JLabel lab10=new JLabel("Closing Balance Wt.(gm)",JLabel.RIGHT);
		JLabel lab11=new JLabel("Category");
		JLabel lab12=new JLabel("Item Name");
		JLabel lab13=new JLabel("Gross Weight (In gm)");
		JLabel lab14=new JLabel("Tounch");
		JLabel lab15=new JLabel("Fine Weight (In gm)");
		...
		JLabel lab21=new JLabel("Old Balance (Rs.)",JLabel.RIGHT);
		JLabel lab22=new JLabel("Closing Balance (Rs.)",JLabel.RIGHT);
		...
		String heading[]={"Category Name","Item Name","Weight","Tounch","Pieces","Fine Wt."};
		dtm=new DefaultTableModel(heading,0);
		grid=new JTable(dtm);
		JScrollPane jsp=new JScrollPane(grid);
		totalPurWtL=new JLabel("0",JLabel.RIGHT);
		totalPurFineWtL=new JLabel("0",JLabel.RIGHT);
		lastBal1L=new JLabel("0",JLabel.RIGHT);
		lastBal2L=new JLabel("0",JLabel.RIGHT);
		lastBal3L=new JLabel("0",JLabel.RIGHT);
		lastBal4L=new JLabel("0",JLabel.RIGHT);
		curBal1L=new JLabel("0",JLabel.RIGHT);
		curBal2L=new JLabel("0",JLabel.RIGHT);
		curBal3L=new JLabel("0",JLabel.RIGHT);
		curBal4L=new JLabel("0",JLabel.RIGHT);
		...
		depositeTb=new JToggleButton("Deposite");
		...
		billNoLb=new JLabel("",JLabel.RIGHT);	
		lab8.setBounds(10,10,150,20);
		lab7.setBounds(500,10,150,20);
		...
		lab9.setBounds(540,240,200,20);
		lab10.setBounds(540,500,200,20);
		lab11.setBounds(10,290,150,20);
		lab12.setBounds(10,320,150,20);
		lab13.setBounds(10,350,150,20);
		lab14.setBounds(10,380,150,20);
		lab15.setBounds(10,410,150,20);
		lab16.setBounds(10,440,150,20);
		lab17.setBounds(10,550,150,20);
		lab18.setBounds(270,530,150,20);
		lab19.setBounds(420,530,150,20);
		lab20.setBounds(570,530,150,20);		
		lab21.setBounds(822,240,150,20);
		lab22.setBounds(822,500,150,20);
		drCrLb.setBounds(1090,500,40,20);
		partyCb.setBounds(100,10,250,20);
		dateTf.setBounds(550,10,110,20);
		categoryCb.setBounds(140,40,190,20);
		itemCb.setBounds(140,70,190,20);
		openTf.setBounds(140,100,100,20);
		tounchTf.setBounds(140,130,100,20);lastTounchLb.setBounds(250,130,100,20);
		fineWtLb.setBounds(140,160,100,20);
		pieceTf.setBounds(140,190,100,20);
		addNewBtn.setBounds(270,190,40,25);
		updateBtn.setBounds(320,190,40,25);
		totalPurWtL.setBounds(750,220,90,20);
		totalPurFineWtL.setBounds(760+260,220,90,20);
		lastBal1L.setBounds(750,240,90,20);
		lastBal2L.setBounds(842,240,88,20);
		lastBal3L.setBounds(982,240,88,20);
		lastBal4L.setBounds(1022,240,88,20);
		curBal1L.setBounds(750,500,90,20);
		curBal2L.setBounds(842,500,88,20);
		curBal3L.setBounds(982,500,88,20);
		curBal4L.setBounds(1022,500,88,20);
		//down side objects
		categoryCb1.setBounds(140,290,190,20);
		itemCb1.setBounds(140,320,190,20);
		openTf1.setBounds(140,350,100,20);
		tounchTf1.setBounds(140,380,100,20);lastTounchLb1.setBounds(250,380,100,20);
		fineWtLb1.setBounds(140,410,100,20);
		pieceTf1.setBounds(140,440,100,20);
		addNewBtn1.setBounds(270,440,40,25);
		updateBtn1.setBounds(320,440,40,25);
		totalPurWtL1.setBounds(750,470,90,20);
		totalPurFineWtL1.setBounds(760+260,470,90,20);
		...
		depositeTb.setBounds(1000,550,120,20);
		depositeTf.setBounds(1000,570,80,20);
		depositeBtn.setBounds(1000,590,120,20);
		billNoLb.setBounds(1000,10,120,20);
		drCrLb1.setBounds(1090,240,88,20);
		drCrCb.setBounds(1080,570,40,20);
		
		//addBtn.setBounds(144,600,100,25);	
		addBtn.setBounds(396,610,100,25);
		printBtn.setBounds(498,610,100,25);
		resetBtn.setBounds(600,610,100,25);
		exitBtn.setBounds(702,610,100,25);
		jsp.setBounds(370,40,750,180);
		jsp1.setBounds(370,290,750,180);
		
		newPartyBtn.setBounds(360,10,20,20);
		newCategoryBtn.setBounds(340,40,20,20);
		newItemBtn.setBounds(340,70,20,20);
		preBillBtn.setBounds(750,10,20,20);
		nextBillBtn.setBounds(780	,10,20,20);
		newCategoryBtn1.setBounds(340,290,20,20);
		newItemBtn1.setBounds(340,320,20,20);
		...
		DefaultTableCellRenderer CRLeft = new DefaultTableCellRenderer();
      	...
      	CRRight.setHorizontalAlignment(JLabel.RIGHT);
   		...
   		totalPurWtL.setBackground(new Color(123,255,219));
		totalPurFineWtL.setBackground(new Color(123,255,219));
		...
		totalPurWtL1.setOpaque(true);
   		...
   		totalPurWtL1.setBackground(new Color(123,255,219));
		totalPurFineWtL1.setBackground(new Color(123,255,219));
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		else if(e.getSource()==partyCb)
		{
			...
			{			
				...
				/*
				//CODE TO UPDATE WRONG CLOSING WEIGHT
				//START
				try
				{				
    	        		...
    	        		Connection cn=DriverManager.getConnection("jdbc:odbc:jweldsn","zed","zed"); 
				   		...
				   		ResultSet rs;
				   		String partynm=str;
						rs=st.executeQuery("select p_s_no from Purchase where p_Name='"+partynm+"' and p_s_no<"+Integer.parseInt(billNoLb.getText())+" order by p_s_no desc");
   	        		    if(rs.next())
   	        		    {
   	        		    	int justLastBillNo=rs.getInt(1);
	   	        		    rs=st.executeQuery("select field5 from Purchase_x where p_s_no="+justLastBillNo+"");
	   	        		    if(rs.next())
	   	        		    {
	   	        		    	String closingWt=rs.getString(1);
	   	        		    	System.out.println("closing weight="+closingWt);
	   	        		   		String openingWt=lastBal1L.getText(); 	
	   	        		   		if(closingWt.equals(openingWt)==false)
	   	        		   		{
	   	        		   			patch1 pt=new patch1();
        		   					pt.setSize(200,300);
									pt.setVisible(true);
									pt.updatedata(partynm);

									pt.dispose();
									
									//billNoLb.setText(openedBillNo);
	   	        		   			//showPreBill();
	   	        		   		}
	   	        		    }
   	        		    }				
				...
				{
					System.out.println("Error...time of weight updation...."+ex);
				}
				//END
				*/
		...
		{
			PartyCreationViaScreenP pc=new PartyCreationViaScreenP(desk);	
		}
		...
		{
			AddItemViaScreenP pc=new AddItemViaScreenP(desk);	
		}		
	...
	public void focusGained(FocusEvent e)
	{
		...
		{	
			...
			{
				System.out.println("error...563..."+x);
			}
		}
		else if(e.getSource()==tounchTf)
		{
	...
	private boolean isBillExist()
	{
		try
		{
	   		...
	   		Statement st=cn.createStatement();
	   		ResultSet rs;
	   		rs=st.executeQuery("select * from Purchase where p_s_no="+Integer.parseInt(billNoLb.getText()));
	   		if(rs.next())
	   		{
	   			return true;
	   		}
	   		...
	   		{
	   			rs=st.executeQuery("select * from Purchase_x where p_s_no="+Integer.parseInt(billNoLb.getText()));
	   			{
	   				if(rs.next())
	   				{
	   					return true;
	...
	private boolean rollBackData()
	{
		try
		{
	   		...
	   		rs=st.executeQuery("select * from Purchase where p_s_no="+Integer.parseInt(billNoLb.getText())+" and t_type='p'");
	   		while(rs.next())
	   		{
			...
			rs=st.executeQuery("select * from Purchase where p_s_no="+Integer.parseInt(billNoLb.getText())+" and t_type='a'");
	   		while(rs.next())
	   		{
	   			String v2=rs.getString("i_name");
	   			String v6=rs.getString("f_wt");
        		...
        		if(rs.next())
        		{
        			...
        			if(rs.next())
        			{
        				...
        				System.out.println("rs="+s1rs+"      gm="+s2gm);
        				rs=st.executeQuery("select slx.field3,slx.field4,slx.field5,slx.field6,slx.p_s_no from Purchase_x slx,Purchase sl where sl.p_Name='"+partyCb.getSelectedItem().toString()+"' and sl.p_s_no=slx.p_s_no and slx.p_s_no>"+Integer.parseInt(billNoLb.getText()));
        				while(rs.next())
        				{        				
        					...
        					int id=rs.getInt(5);
        					System.out.println("update Purchase_x set field3='"+(""+gm1)+"',field4='"+(""+rs1)+"',field5='"+(""+gm2)+"',field6='"+(""+rs2)+"' where p_s_no='"+id);
        					stTemp.executeUpdate("update Purchase_x set field3='"+(""+gm1)+"',field4='"+(""+rs1)+"',field5='"+(""+gm2)+"',field6='"+(""+rs2)+"' where p_s_no="+id);
        				}	
        			}
        		}
			//}
			System.out.println("ok4 ...");
			st.executeUpdate("delete  from Purchase where p_s_no="+Integer.parseInt(billNoLb.getText()));
			System.out.println("ok5 ...");
			st.executeUpdate("delete  from Purchase_x where p_s_no="+Integer.parseInt(billNoLb.getText()));
			...
			if(dateTf.getText().trim().length()>0)
			{
				//if(grid.getRowCount()>0 || grid1.getRowCount()>0)
				{
    	        	...
    	        	Connection cn=DriverManager.getConnection("jdbc:odbc:jweldsn","zed","zed"); 
        			    		...
        			    		ResultSet rs,rsTemp,rs2;
        			    		rs2=st.executeQuery("select max(s_s_no) from LastTounchP");
		    	    		    	if(rs2.next())
		    	    		    	{
        			    		...
        			    		if(updateFlag==false)
		    	    		    {
		    	    		    	...
		    	    		    	rs=st.executeQuery("select max(p_s_no) from Purchase_x");
			    	    		    if(rs.next())
			    	    		    {
			    	    		    	int n=rs.getInt(1)+1;
		    		    		    	if(n>psno)
		    	    		    ...
		    	    		    if(partynm.equals("-Select Party-"))
		    	    		    	{
		    	    		    		JOptionPane.showMessageDialog(null,"Please Select The Party Name");
		    	    		    ...
		    	    		    for(int i=0;i<grid.getRowCount();i++)
		    	    		    {
									...
									String v7="p";
									st.executeUpdate("insert into Purchase values("+psno+",'"+partynm+"','"+dt+"','"+v1+"','"+v2+"','"+v3+"','"+v4+"','"+v5+"','"+v6+"','"+v7+"')");
									st.executeUpdate("insert into LastTounchP values("+psno1+",'"+partynm+"','"+v4+"','"+v2+"','"+v7+"')");
		    	    		    ...
		    	    		    if(contFlag==0)
		    	    		    {
		    	    		    	st.executeUpdate("insert into Purchase values("+psno+",'"+partynm+"','"+dt+"','','',0,0,0,0,'')");
		    	    		    }
		    	    		    ...
		    	    		    if(pendingTb.isSelected()==true)
		    	    		    	...
		    	    		    	st.executeUpdate("insert into Purchase_x values("+psno+","+d1+","+d2+","+d3+","+d5+","+d7+","+d9+","+d11+","+d12+","+d13+","+d14+","+d15+","+d16+","+d17+","+d18+",'"+rateType+"',"+d19+")");
		    	    		    	
									//update stock-->'partyDetails' table
		    	    		    	rs=st.executeQuery("select max(p_s_no) from Purchase where p_name='"+partyCb.getSelectedItem()+"'");
		    	    		    	if(rs.next())
		    	    		    	{
		    	    		    		psno=rs.getInt(1);
		    	    		    	}
		    	    		    	/*rs=st.executeQuery("select max(slx.p_s_no) from Purchase sl,Purchase_x slx where slx.p_s_no=sl.p_s_no and sl.p_name='"+partyCb.getSelectedItem()+"'");
			    	    		    if(rs.next())
			    	    		    {
			    	    		    	int n=rs.getInt(1);
		    		    		    	if(n>psno)
		    	    			    ...
		    	    			    //JOptionPane.showMessageDialog(null,""+psno);
	            					JOptionPane.showMessageDialog(null,"Process completed.");
									rs=st.executeQuery("select * from Purchase_x where p_s_no="+psno);
									if(rs.next())										
									{
										stTemp.executeUpdate("update partyDetails set currentAmt='"+rs.getString("field6")+"',currentWt='"+rs.getString("field5")+"' where 	partyName='"+partyCb.getSelectedItem()+"' and p_type='p'");
									}
			...
			if(dateTf.getText().trim().length()>0)
			{
				//if(grid.getRowCount()>0 || grid1.getRowCount()>0)
				{
    	        	...
    	        	Connection cn=DriverManager.getConnection("jdbc:odbc:jweldsn","zed","zed"); 
        			    		...
        			    		ResultSet rs,rsTemp;
        			    		st.executeUpdate("delete  from Purchase_temp");
        			    		st.executeUpdate("delete  from Purchase_x_temp");
        			    		
		    	    		    String partynm=""+partyCb.getSelectedItem();
		    	    		    
		    	    		    if(partynm.equals("-Select Party-"))
		    	    		    	{
		    	    		    		JOptionPane.showMessageDialog(null,"Please Select Correct Party Name");
		    	    		    		partyCb.requestFocus();
		    	    		    	}
		    	    		    else
		    	    		    	{
		    	    		    ...
		    	    		    for(int i=0;i<grid.getRowCount();i++)
		    	    		    {
		    	    		    	...
		    	    		    	String v6=""+grid.getValueAt(i,5);
									String v7="p";
									st.executeUpdate("insert into Purchase_temp values("+psno+",'"+partynm+"','"+dt+"','"+v1+"','"+v2+"','"+v3+"','"+v4+"','"+v5+"','"+v6+"','"+v7+"')");
		    	    		    ...
		    	    		    if(pendingTb.isSelected()==true)
		    	    		    	d18=true;
		    	    		    String rateType=""+gmOrBhari.getSelectedItem();	
		    	    		    st.executeUpdate("insert into Purchase_x_temp values("+psno+","+d1+","+d2+","+d3+","+d5+","+d7+","+d9+","+d11+","+d12+","+d13+","+d14+","+d15+","+d16+","+d17+","+d18+",'"+rateType+"',"+d19+")");
	...
	private void getItemName()
	{
			try
			{
        		    ...
        		    rs=st.executeQuery("select * from itemList  order by itemName");//where categoryName='"+categoryCb.getSelectedItem()+"'
        		    while(rs.next())
        		    {
        		    	itemCb.addItem(rs.getString("itemName"));        		    	
        		    }
		           	cn.close();
            }	
			catch(Exception x)
	...
	private void getLastTounch()
	{
			try
			{
        		    ...
        		    //System.out.println("2222222->>"+"select  tnh from LastTounchP where  p_name='"+pname+"' and s_s_no<"+bno+" and t_type='p' order by s_s_no desc");
        		    ResultSet rs=st.executeQuery("select tnh from LastTounchP where i_name='"+iname+"' and p_name='"+pname+"'  and t_type='p' order by s_s_no desc");//and s_s_no<"+bno+"
        		    ...
        		    {
        		    	lastTounchLb.setText("NA");
        		    }
  					cn.close();
            }	
			catch(Exception x)
			{
				System.out.println("er01.d.."+x);
			}		
	}
	private void getLastTounch1()
	{
			try
			{
	            	...
	            	int bno=Integer.parseInt(billNoLb.getText());
        		    ResultSet rs=st.executeQuery("select tnh from LastTounchP where i_name='"+iname+"' and p_name='"+pname+"'  and t_type='a' order by s_s_no desc");//and s_s_no<"+bno+"
        		    //System.out.println("err1.---->"+"select tnh from LastTounchP where  p_name='"+pname+"' and s_s_no<"+bno+" and t_type='a' order by s_s_no desc");
        		    if(rs.next())
        		    {
	...
	private void getLastBalance()
	{
			try
			{
        		    ...
        		    lastBal3L.setText("0");
        		    lastBal4L.setText("0");
        		    //System.out.println("select purx.field7 from Purchase_x purx,Purchase pur where pur.p_name='"+partyCb.getSelectedItem()+"'  order by purx.p_date desc");
        		    //rs=st.executeQuery("select purx.field5,purx.field6 from Purchase_x purx,Purchase pur where pur.p_name='"+partyCb.getSelectedItem()+"' and purx.p_s_no=pur.p_s_no order by pur.p_date desc,pur.p_s_no desc");
	...
	private void showPreBill()
	{
		...
		try
		{
        		    ...
        		    ResultSet rs;
					String partynm=""+partyCb.getSelectedItem();        		    
        		    rs=st.executeQuery("select * from Purchase where p_Name='"+partynm+"' and p_s_no<"+Integer.parseInt(billNoLb.getText())+" order by p_s_no desc");
        		    if(rs.next())
        		    {
        		    	reset();
        		    	partyCb.setSelectedItem(partynm);        		    	
        		    	billNoLb.setText(rs.getString("p_s_no"));        		    	

						String temp=""+rs.getDate("p_date");
	...
	private void showNextBill()
	{
		...
		try
		{
        		    ...
        		    ResultSet rs;
					String partynm=""+partyCb.getSelectedItem();        		    
        		    rs=st.executeQuery("select * from Purchase where p_Name='"+partynm+"' and p_s_no>"+Integer.parseInt(billNoLb.getText())+" order by p_s_no");
        		    if(rs.next())
        		    {
        		    	reset();
        		    	partyCb.setSelectedItem(partynm);        		    	
        		    	...
        		    	if(rs.next())
        		    	{
        		    		System.out.println("inside purchase_x");
        		    		totalPurWtL.setText(rs.getString("field1"));
        		    		totalPurFineWtL.setText(rs.getString("field2"));
        		    		lastBal1L.setText(rs.getString("field3"));
	...
	private void showBill()
	{
		try
		{
        		    ...
        		    rs=st.executeQuery("select * from Purchase where  p_s_no="+Integer.parseInt(billNoLb.getText())+" order by p_s_no");
        		    if(rs.next())
        		    {
        		    	reset();
	...
	class printbill extends JFrame 
    {
                public printbill()
                {
                        try
                        {
								...
								rs=st.executeQuery("select * from Purchase where p_s_no="+Integer.parseInt(billno)+" and t_type='p'");
		    	    		    while(rs.next())
		    	    		    {
		    	    		    ...
		    	    		    rs=st.executeQuery("select slx.field3,sl.p_date from Purchase_x slx,Purchase sl where slx.p_s_no="+Integer.parseInt(billno)+" and sl.p_s_no=slx.p_s_no");
		    	    		    if(rs.next())
		    	    		    {
		    	    		    	temp=""+rs.getDate(2);
		    	    		    	l=temp.length();
								...
								rs=st.executeQuery("select * from Purchase where p_s_no="+Integer.parseInt(billno)+" and t_type='a'");
		    	    		    while(rs.next())
		    	    		    {
		    	    		    	temp=rs.getString("i_name").trim()	;
		    	    		    	pw.print(temp);
		    	    		    ...
		    	    		    rs=st.executeQuery("select slx.field9,slx.field10,slx.field11,slx.rate_type from Purchase_x slx where slx.p_s_no="+Integer.parseInt(billno)+"");
		    	    		    if(rs.next())
		    	    		    {
								...
								//space="    0.00       0.00";
        					    //pw.print(space);
		    	    		    rs=st.executeQuery("select field4,field6,jama,field11 from Purchase_x where p_s_no="+Integer.parseInt(billno)+"");
		    	    		    if(rs.next())
								{
            ...
            */
			...
			{			
		        try
        		{
					...
					rs=st.executeQuery("select * from Purchase_temp where p_s_no="+Integer.parseInt(billno)+" and t_type='p'");
		    	    while(rs.next())
		    	    {
		    	    	top+=13;
						g2.setFont(fp8);
					...
					System.out.println("select slx.field3,sl.p_date from Purchase_x_temp slx,Purchase_temp sl where slx.p_s_no="+Integer.parseInt(billno)+" and sl.p_s_no=slx.p_s_no");
   	    		    rs=st.executeQuery("select slx.field3 from Purchase_x_temp slx where slx.p_s_no="+Integer.parseInt(billno)+"");
   	    		    if(rs.next())
   	    		    {
		    	    	...
		    	    	rs=st.executeQuery("select * from Purchase where p_s_no<"+Integer.parseInt(billno)+" and p_name='"+partyCb.getSelectedItem()+"' order by p_date desc");
		    	    	if(rs.next())
		    	    	{
		    	    		g2.setFont(fp9);
		    		    	fm=g2.getFontMetrics();
							temp=""+rs.getDate("p_date");
					...
					g2.setFont(fp9);
					rs=st.executeQuery("select * from Purchase_temp where p_s_no="+Integer.parseInt(billno)+" and t_type='a'");
		    	    while(rs.next())
		    	    {
		    	    	top+=13;
						g2.setFont(fp8);
					...
					rs=st.executeQuery("select slx.field9,slx.field10,slx.field11,slx.rate_type from Purchase_x_temp slx where slx.p_s_no="+Integer.parseInt(billno)+"");
		    	    if(rs.next())
		    	    {
		    	    	//top+=13;
		            ...
		            g2.drawString(temp,10,top);
   	    		    ...
   	    		    g2.setFont(fp8);
   	    		    fm=g2.getFontMetrics();
					rs=st.executeQuery("select field4,field6,jama,field11 from Purchase_x_temp where p_s_no="+Integer.parseInt(billno)+"");
   	    		    if(rs.next())
					{
						top+=13;
			    	    temp=""+rs.getBigDecimal(4).setScale(2,5);
					...
					String partynm="";					
					rs1=st1.executeQuery("select * from Purchase_details where bill_no="+Integer.parseInt(printToBillNo));
					if(rs1.next())
					{
						top+=10;
						g2.setFont(fb8);
					...
					//ABOUT BUYER
					rs=st.executeQuery("select * from Purchase_tin_details where billno='"+printToBillNo+"'");
					if(rs.next())
						flag=1;
					...
					//code to print Purchase data
					rs=st.executeQuery("select * from Purchase_details where bill_no="+Integer.parseInt(printToBillNo)+"");											
					while(rs.next())
					{
						top+=15;
						g2.setFont(fp8);
