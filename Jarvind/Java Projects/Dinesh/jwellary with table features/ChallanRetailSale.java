...
public class ChallanRetailSale extends JFrame implements ActionListener,MouseListener,KeyListener,FocusListener,InternalFrameListener,TableModelListener
{
	Container con;
	JInternalFrame frm;
	...
	public ChallanRetailSale(JDesktopPane desk,int billno)
	{
		this.desk=desk;
		frm=new JInternalFrame("Make Challan # Retail Sale",false,true,false,true);
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		else if(e.getSource()==deletePM)
		{
			...
			if(res==JOptionPane.YES_OPTION)
			{
				...
				totalAmountL.setText(""+(new BigDecimal(getTotalInDecimal(grid,8))).setScale(2,5));
		...
		else if(e.getSource()==deletePM1)
		{
			...
			if(res==JOptionPane.YES_OPTION)
			{
				...
				totalAmountL1.setText(""+(new BigDecimal(getTotalInDecimal(grid1,8))).setScale(2,5));
				...
				//if(grid.getRowCount()>0 || grid1.getRowCount()>0)
				{
		    	   		    ...
		    	   		    for(int i=0;i<grid.getRowCount();i++)
		    	    	    {
								...
								if(v1.equals("null")==false && v1.equals("")==false)
								{
									...
									qry="insert into saleRetailchallan values("+psno+",'"+partynm+"','"+dt+"',"+itemcode;
