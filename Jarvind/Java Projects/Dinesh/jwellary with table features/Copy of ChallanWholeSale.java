...
*/
public class TableArrowKeyHandler
implements KeyListener {
private JTable m_table ;

/**
* @author SamirKhatri on 2009.03.16
* @param p_table
*/
...
//If you are going to do some GUI related task then 
//use invokeLater thread.
...
if ( (nRow > -1 && nRow < m_table.getRowCount()) && (nCol > -1 && nCol < m_table.getColumnCount())) {
//get selected object in table
...
// Here you can play with selected object
//----------------------------------------
System.out.println("key pressed....."+objSel);
