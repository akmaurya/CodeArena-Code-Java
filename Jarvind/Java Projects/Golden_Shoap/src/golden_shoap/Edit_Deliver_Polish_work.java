...
// static int sNo=0;
    ...
    private void initComponents() {
        ...
        jPanel1.setBounds(310, 330, 370, 180);
   ...
   {                    
                         ...
                         String date1=jLabel10.getText();
                         String d2[]=date1.split("-");
                         date1=d2[1]+"-"+d2[0]+"-"+d2[2];

                         String date2=jLabel30.getText();
                         String d3[]=date2.split("-");
                         date2=d3[1]+"-"+d3[0]+"-"+d3[2];
                         ...
                         double opening=Double.valueOf(Utility.getSingleValue(qry));
                         System.out.println("<<<<<<<<<<<<<Opening"+opening);
                         //For total receive amount on the back date
                         qry="select voucher_amount from receive_voucher where voucher_type='Receive' and voucher_date<=#"+date1+"# and by_ac="+AccountCode+"";
                         String data[][]=Utility.getInformationDD(qry,1);
                         double paidAmount=0;
                         for(int i=0;i<data.length;i++)
                         { 
                             paidAmount=(paidAmount+(Double.valueOf(data[i][0])));
                         }
                         System.out.println("<<<<<<<<<<<<<paidAmount"+paidAmount);
                         //End
                      
                         qry="Select payable_amount from polish_details where purja_number<="+Integer.parseInt(jLabel11.getText())+" and ac_code="+AccountCode+"";
                         String data1[][]=Utility.getInformationDD(qry,1);
                         double payableAmount=0;
                         for(int i=0;i<data1.length;i++)
                         { 
                             payableAmount=payableAmount+(Double.valueOf(data1[i][0]));
                         }
                          System.out.println("<<<<<<<<<<<<<payableAmount"+payableAmount);
                         jLabel34.setText(""+(((Double.valueOf(payableAmount)+opening)-(Double.valueOf(paidAmount)))));

                          */
                            qry="Select payable_amount from polish_details where purja_number="+Integer.parseInt(jLabel11.getText())+" and ac_code="+AccountCode+"";
                            String payableAmount=Utility.getSingleValue(qry);

                            qry="select voucher_amount from receive_voucher where voucher_type='Receive' and (voucher_date=#"+date1+"# or voucher_date=#"+date2+"#) and by_ac="+AccountCode+" and purja_number="+Integer.parseInt(jLabel11.getText())+"";
                            String receiveAmount=Utility.getSingleValue(qry);
                            if(Double.valueOf(receiveAmount.length())==0)
                            {
                                receiveAmount=""+0;
                            }
                            ...
                            dr=(dr-Double.valueOf(payableAmount));
                            cr=(cr-Double.valueOf(receiveAmount));

                            java.math.BigDecimal bd=new java.math.BigDecimal(dr-cr);
                            jLabel34.setText(""+bd.setScale(3,5));
   ...
   public void edetingTotal()
        ...
        {       int row=jTable1.getSelectedRow();
                ...
                //for weight
                          ...
                          {             if(totalRow==1)
                                        {
                                             ...
                                             unit=""+jTable1.getValueAt(totalRow-1,11);
                                             if(quantityAP.length()==0)
                                             {
                                                 quantityAP="0";
                                             }
                        ...
                        {                         weight=""+jTable1.getValueAt(row-1,8);
                                                  quantityAP=""+jTable1.getValueAt(row-1,9);
                                                  System.out.println("quantityAP"+quantityAP);
                                                  unit=""+jTable1.getValueAt(row-1,11);
                                                  if(quantityAP.length()==0)
                                                  {
                                                        quantityAP="0";
                                                  }
                ...
                if(paymentApply.equals("After Polish")&&(unit.equals("Kg")))
                {   System.out.println("Weight====="+weight);
                    System.out.println("Enter in the weight portion......................................................");
                ...
                if(paymentApply.equals("After Polish")&&(unit.equals("Kg")==false))
                {   System.out.println("Quantity====="+quantityAP);
                    System.out.println("Enter in the Quantity portion.........................................................");
     ...
     public void MousecalculateTotal()
    {
                ...
                for(int i=0;i<totalRow;i++)
                {
                     ...
                     quantity=""+jTable1.getValueAt(i,9);
                     unit=""+jTable1.getValueAt(i,11);
       ...
       //if((Double.valueOf(jTextField7.getText())>=0) || (Double.valueOf(jLabel7.getText())>=0))
        //{
                     ...
                     // if((Double.valueOf(jLabel7.getText()))>=0 && (Double.valueOf(jTextField7.getText()))>=0)
                      ...
                      {
                               qry="Update receive_voucher set voucher_amount="+totalPaidAmount+",voucher_date=#"+date1+"# where purja_number="+gPurjaNumber+"";
   ...
   public void callReturnAmountPanel()
    {
                     ...
                     double payableAmount=Double.valueOf((Double.valueOf(jTextField6.getText()))-((Double.valueOf(jLabel7.getText()))+(Double.valueOf(jTextField2.getText()))));
 ...
 boolean bn=checkingOfWeight();
    ...
    private void jTextField7KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField7KeyReleased
        ...
        if(Utility.isBlank(jTextField7.getText())==false)
                         ...
                         {          if(jTextField7.getText().equals("-"))
                                    {}
                                       ...
                                       {    double paidAmount=(Double.valueOf(jTextField7.getText()));
                                            ...
                                            java.math.BigDecimal bd1=new java.math.BigDecimal(a);
                                            jLabel32.setText(""+bd1.setScale(2,5));
                                        }
                        }
                        else
                        {
                ...
                {double remainingAmount=(Double.valueOf(jTextField6.getText())-(Double.valueOf(jTextField2.getText())+Double.valueOf(jLabel7.getText())));
                java.math.BigDecimal bd1=new java.math.BigDecimal((oldDueAmount)+(remainingAmount));
                 jLabel32.setText(""+bd1.setScale(2,5));
               }
