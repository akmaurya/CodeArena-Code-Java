...
// static int sNo=0;
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(510, 20, 110, 23);
        ...
        jComboBox1.setBounds(290, 20, 190, 23);
        ...
        jComboBox2.setBounds(300, 80, 170, 23);
        ...
        jComboBox3.setBounds(560, 80, 130, 23);
        ...
        jButton4.setBounds(180, 510, 150, 30);
        ...
        jLabel10.setBounds(620, 20, 90, 23);
        ...
        jLabel12.setBounds(710, 20, 30, 23);
        ...
        jLabel15.setBounds(480, 80, 80, 23);
        ...
        jTextField8.setBounds(170, 20, 110, 23);
        ...
        jButton8.setBounds(10, 560, 160, 30);
        ...
        jButton7.setBounds(480, 20, 20, 25);
    ...
    {
        String qry="select ac_name from ac_master where ac_code="+jLabel11.getText()+"";
        String name=Utility.getSingleValue(qry);
                      jComboBox1.removeAllItems();
                      int accountCategory=1;
                      int accountGroup=11;
                      qry="select ac_name from ac_master where ac_group_code="+accountGroup+" and ac_category_code="+accountCategory+" order by ac_name";
...
//       setPurjaNumber();
    ...
    private void jTextField8KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField8KeyReleased
       ...
       /*//to set old name if textField is empty
           if((jTextField8.getText()).equals(""))
           {
            qry="select ac_name from ac_master where ac_code="+(Integer.parseInt(data[0][1]))+"";
            String oldName=Utility.getSingleValue(qry);
            jComboBox1.setSelectedItem(oldName);
           }
       //End*/
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        // TODO add your handling code here:
      int check=javax.swing.JOptionPane.showConfirmDialog(this,"Are you sure to reject this purja ?" ,"Confirm Window",javax.swing.JOptionPane.YES_NO_OPTION,javax.swing.JOptionPane.QUESTION_MESSAGE);
      if(check==javax.swing.JOptionPane.YES_OPTION)
      {
             rollback();
             this.dispose();
