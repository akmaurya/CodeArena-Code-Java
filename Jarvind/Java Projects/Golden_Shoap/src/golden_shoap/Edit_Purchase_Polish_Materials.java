 ...
 * @author user1
 */
public class Edit_Purchase_Polish_Materials extends javax.swing.JInternalFrame {
 javax.swing.table.DefaultTableModel dtm;
 String userId="Zed";
 int gBillNumber=0;
// static int sNo=0;
    /** Creates new form Police_customer_work */
    public Edit_Purchase_Polish_Materials(int billNumber) {
        initComponents();
        gBillNumber=billNumber;
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Edit Purchase Polish Materials");
        ...
        jLabel1.setBounds(420, 20, 100, 23);
        ...
        jComboBox1.setBounds(220, 20, 170, 23);
        ...
        jButton4.setBounds(210, 480, 140, 30);
        ...
        jButton6.setBounds(500, 480, 120, 30);
        ...
        jButton5.setBounds(360, 480, 120, 30);
        ...
        jLabel15.setBounds(640, 460, 120, 25);
        ...
        jTextField8.setBounds(130, 20, 80, 23);
        ...
        jLabel23.setBounds(0, 0, 968, 640);
    ...
    public void loadTable(int billNumber)
    {                   
                       String qry="Select ac_code from purchase_polish_materials where bill_number="+billNumber+"";
                       String data[][]=Utility.getInformationDD(qry,1);
                       int acCode=Integer.parseInt(""+data[0][0]);


                       qry="Select ac_name from ac_master where ac_code="+acCode+"";
                       String acName=""+Utility.getSingleValue(qry);
                      
                       jComboBox1.setSelectedItem(acName);
                       jLabel11.setText(""+billNumber);

                       qry="Select purchasing_date from purchase_polish_materials where bill_number="+billNumber+"";
                       //to set date
                       String date[][]=Utility.getInformationDD(qry,1);

                        String d[]=(date[0][0].split(" "));
                        String d1[]=d[0].split("-");
                        jLabel10.setText((d1[2]+"-"+d1[1]+"-"+d1[0]));

                       qry="Select distinct packing_charge from purchase_polish_materials where bill_number="+billNumber+"";
                       String packingCharge=Utility.getSingleValue(qry);
                       java.math.BigDecimal bd=new java.math.BigDecimal(packingCharge);
                        jTextField1.setText(""+bd.setScale(2,5));


                       dtm.setRowCount(0);
                       int count=0;
                       qry="Select * from purchase_polish_materials where bill_number="+billNumber+"";
                                             
                                            String load[][]=Utility.getInformationDD(qry, 12);
                                            System.out.println("acName1="+acName);
                                            double total=0;
                                            String totamt="";
                                            String arr[];
                                            if(load.length>0)
                                            ...
                                            double payableAmount=Double.valueOf(load[0][9]);
                                            ...
                                            double discount=Double.valueOf(load[0][8]);
                                            bd4=new java.math.BigDecimal(discount);
                                            jTextField5.setText(""+bd4.setScale(2,5));
     
                                            jLabel23.setText(""+discount);
                                           
                                            bd4=new java.math.BigDecimal(Double.valueOf(jTextField4.getText()));
                                            ...
                                            bd4=new java.math.BigDecimal(load[0][10]);
    ...
    {                 String qry="select material_name from polish_material order by material_name"  ;
                      String[][] data=Utility.getInformationDD(qry,1);
    ...
    {                       String qry="select distinct discount from purchase_polish_materials where bill_number="+gBillNumber+"  ";
                            String discount=Utility.getSingleValue(qry);
                            System.out.println("discount"+discount);
                            int acCode=8;
                            qry="select ac_cr from ac_smry where ac_code="+acCode+"";
                            double acCr=Double.valueOf(Utility.getSingleValue(qry));
                            acCr=acCr-(Double.valueOf(discount));
    ...
    public void rollBackPaidAmount()
    {
                              ...
                              qry="select distinct paid_amount from purchase_polish_materials where bill_number="+gBillNumber+"  ";
                              double paidAmount=Double.valueOf(Utility.getSingleValue(qry));
    ...
    public void rollBackUserAndPurchasePolish()
    {
                            ...
                            //to find totalamount
                            qry="select payable_amount,discount from purchase_polish_materials where bill_number="+gBillNumber+"";
                            String data[][]=Utility.getInformationDD(qry,2);

                            double totalAmount=((Double.valueOf(data[0][0]))+(Double.valueOf(data[0][1])));
                            ...
                            qry="select distinct payable_amount from purchase_polish_materials where bill_number="+gBillNumber+"";
                            String payableAmount=Utility.getSingleValue(qry);

                            qry="select ac_cr from ac_smry where ac_code="+acCode+"";
                            double acCr=Double.valueOf(Utility.getSingleValue(qry));
                            acCr=((acCr)-(Double.valueOf(payableAmount)));
                            qry="Update ac_smry set ac_cr="+acCr+" where ac_code="+acCode+"";
                            Utility.saveInformation(qry);
    ...
    public void deleteRecord()
    {
                              ...
                              String qry="delete * from receive_voucher where purja_number="+gBillNumber+" and voucher_type='Payment'";
                              Utility.saveInformation(qry);
                              //to manage ac_smry table

                              //Delete purchase_polish_materials entry
                              qry="delete * from purchase_polish_materials where bill_number="+gBillNumber+"";
                              Utility.saveInformation(qry);
                              //to manage ac_smry table

                              
    }
    public void rollBackMaterialStock()
    {

                        //int row=dtm.getRowCount();
                        //System.out.println("Number of row="+row);
                        String qry="select quantity,material_name from purchase_polish_materials where bill_number="+gBillNumber+"";
                        String data[][]=Utility.getInformationDD(qry,2);
                        double oldQuantity=0;
                        double quantity=0;
                        for(int i=0;i<data.length;i++)
                        {
                                //String materialName=""+jTable1.getValueAt(i,1);
                                //To find old quantity of the material.
                                
                                //System.out.println("old Quantity"+quantity);
                                quantity=Double.valueOf(data[i][0]);
                                qry="select quantity from polish_material where material_name='"+data[i][1]+"'";
                                oldQuantity=Double.valueOf((""+Utility.getSingleValue(qry)));
                                quantity=(oldQuantity-quantity);
                                System.out.println("New Quantity"+quantity);
                                qry="update polish_material set quantity="+quantity+" where material_name='"+data[i][1]+"'";
                                Utility.saveInformation(qry);
                                System.out.println("New Quantity2"+quantity);
                        }
    }
    public void rollBack()
    {
        ...
        rollBackUserAndPurchasePolish();
        
        rollBackMaterialStock();
        System.out.println("Polinter is here..............");
        deleteRecord();
    }
   public boolean save()
    {               rollBack();
         //Check the validation of discount and paid amount text box
          ...
          {   String date=jLabel10.getText();
              ...
              for(int i=0;i<row;i++)
              {
                      ...
                      System.out.println(".............old Quantity"+updateQuantity);
                      updateQuantity=(updateQuantity+quantity);
                      System.out.println("      .........new Quantity"+updateQuantity);
              ...
              if((jButton1.getLabel()).equals("Receive"))
                ...
                else
                {
                  if(jTable1.getRowCount()>0)
                  {
                    ...
                    int scale=Utility.manageUnitDecimal("polish_material_unit","material_unit","scale",jLabel8.getText());
                    jTable1.setValueAt(((bd4.setScale(scale,5))), row, 2);
    ...
    public void takeInput()
    {
         ...
         if(billNumber!=null)
         {
             if(Utility.isInteger(billNumber))
             {
                    ...
                    {
                          javax.swing.JOptionPane.showMessageDialog(this,"Error...bill purja number. " ,"Message Box",javax.swing.JOptionPane.INFORMATION_MESSAGE);

                    }
             }
             else
             {
                      javax.swing.JOptionPane.showMessageDialog(this,"Error...Enter bill number in number format. " ,"Message Box",javax.swing.JOptionPane.INFORMATION_MESSAGE);
             }
         }
    }
    ...
    private void jTable1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTable1KeyPressed
        ...
        if(evt.getKeyCode()==127)
        {
            ...
            if(check==javax.swing.JOptionPane.NO_OPTION)
             ...
             //to subtract polish material stock(deletion of record make effect on polish stock)
                              /*  int selectedRow= jTable1.getSelectedRow();
                                double quantity=Double.valueOf(""+jTable1.getValueAt(selectedRow,2));

                                String materialName=""+jTable1.getValueAt(i,1);
                                quantity=Double.valueOf(""+jTable1.getValueAt(i,6));
                                System.out.println("old Quantity"+quantity);
                                String qry="select quantity from polish_material where material_name='"+materialName+"'";
                                oldQuantity=Double.valueOf((""+Utility.getSingleValue(qry)));
                                quantity=(oldQuantity-quantity);
                                System.out.println("New Quantity"+quantity);
                                qry="update polish_material set quantity="+quantity+" where material_name='"+materialName+"'";
                                Utility.saveInformation(qry);*/
            //End
        }
        ...
        if((jTextField7.getText()).isEmpty() == false && (jTextField5.getText()).isEmpty() == false)
        {
                 ...
                 else if(Utility.isDouble((jTextField5.getText())) == true)
                 {
                        if(Utility.isDouble((jTextField7.getText()))==true)
                        {
                                       ...
                                       if(save()==true)
                                       { int check=javax.swing.JOptionPane.showConfirmDialog(this,"Record sucessfully updated.Do you want to continue ????????. " ,"Message Box",javax.swing.JOptionPane.YES_NO_OPTION);
                                         if(check==0)
                                         {          this.dispose();
                                                    takeInput();
                                         }
