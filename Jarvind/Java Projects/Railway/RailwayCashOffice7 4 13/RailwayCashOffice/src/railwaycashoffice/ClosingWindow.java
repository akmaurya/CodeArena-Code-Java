...
public class ClosingWindow extends javax.swing.JInternalFrame {
    ...
    public ClosingWindow() {
      ...
      // jComboBox2.setEnabled(false);
        ...
        String heading[]={"Sr.No.","Challan No.","Paid Amount","Unpaid Amount","DC No."};
    ...
    private void initComponents() {
        ...
        jButton4.setBounds(30, 540, 320, 30);
        ...
        jButton5.setBounds(370, 540, 320, 30);
        ...
        jButton7.setBounds(380, 130, 310, 30);

        jLabel8.setText("Input DC No. ");
        getContentPane().add(jLabel8);
        jLabel8.setBounds(30, 130, 130, 20);

        jTextField1.setBackground(new java.awt.Color(232, 144, 144));
        ...
        jTextField1.setBounds(160, 130, 200, 25);
    ...
    private void uploadDCNo()
{
    try
    {
     ...
     /*   String qry="Select dp_Code from department_detail where dp_name='"+(""+jComboBox2.getSelectedItem())+"'";
        ...
        if(getDpCode!=null)
        {*/
            String qry="Select max(DC_No) from challan_detail";
            String getDC_No=object1.getSigetngleValue(qry,Main.year);
            System.out.println("getDC_No........"+getDC_No);
            int DCNo=0;
            if(getDC_No!=null)
            ...
            if(getDC_No.equals("-1")==true || getDC_No==null)
            {
                ...
                if(getCode==null || getCode.equals("")==true)
                {
                    qry="Select DC_No from opening_dc_number";
                    String getDC=object1.getSigetngleValue(qry,Main.year);
                    System.out.println("getDC........"+getDC);
                    if(getDC!=null || getDC.equals("")==false)
                    {
       ...
       // String setDate=d1[0]+"-"+d1[1]+"-"+d1[2];
         ...
         if(getCode!=null && dpCode!=null)
         {
             ...
             for(int i=0;i<dtm.getRowCount();i++)
             {
                ...
                qry="update challan_detail set DC_No="+Integer.parseInt(""+jTable1.getValueAt(i,4))+",closing_date='"+setDate+"',closing_status="+"1"+" where cashier_code="+Integer.parseInt(getCode)+" and challan_no="+Integer.parseInt(""+jTable1.getValueAt(i,1))+"";
                bn=object1.saveInformation(qry,Main.year);
