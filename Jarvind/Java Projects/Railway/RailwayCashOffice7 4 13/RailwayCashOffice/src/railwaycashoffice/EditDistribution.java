...
boolean flag=true;
    ...
    public EditDistribution() {
        ...
        String heading1[]={"Sr. No.","Bill Date","PMR No.","CO7","CO6","Cashier No.","Party Name","Amount","Bill Type"};
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel5);
        jLabel5.setBounds(90, 20, 130, 25);
    ...
    try
    {
        ...
        if(getDpCode!=null)
        {
            ...
            if(getDate!=null && getDate.length()>0)
            {
                ...
                qry="Select edate,pmrno,CO7,CO6,cashier_code,partyname,amount,amounttype from build_distribution where dp_code="+Integer.parseInt(getDpCode)+" and edate='"+setDate+"' and paymentDate='"+deadDate+"' order by pmrno";
                String loadDetail[][]=object1.getInformationDD(qry, 8,Main.year);
                if(loadDetail!=null)
                {
...
private boolean updateRecord()
{
        ...
        if(getDpCode!=null)
        {
            ...
            else
            {
                ...
                //--log table creation close
                  ...
                  qry="update build_distribution set edate='"+setDate+"',CO7="+Integer.parseInt(jTextField1.getText().trim())+",CO6="+Integer.parseInt(jTextField2.getText().trim())+",cashier_code="+Integer.parseInt(getCashierCode)+",partyname='"+jTextField4.getText().trim().toUpperCase()+"',amount="+Double.valueOf(jTextField5.getText().trim())+",amounttype='"+(jComboBox2.getSelectedItem())+"' where  dp_code="+Integer.parseInt(getDpCode)+" and pmrno="+jLabel5.getText()+" and edate='"+date+"'";
    ...
    private boolean deleteRecord()
    {
		...
		catch(Exception e)
		{
            ...
            if(response==javax.swing.JOptionPane.YES_OPTION)
            {
                ...
                //--log table creation close
                qry="delete * from build_distribution  where  dp_code="+Integer.parseInt(getDpCode)+" and pmrno="+jLabel5.getText()+" and edate='"+setDate+"'";
                boolean bn=object1.saveInformation(qry,Main.year);
		...
		catch(Exception e)
		{
            ...
            /*if(chno!=null &&(! (chno.equals(""))))
            {
                ...
                if(status==0)
                {
                     ...
                     qry="select edate from build_distribution where dp_code="+dept_code+" and cashier_code="+cascode+" and status=0 order by edate desc";
                     String matchDate[][]=object1.getInformationDD(qry,1, Main.year);
                     if(matchDate!=null && matchDate.length>0)
                     {
                         
                         String t[]=jLabel9.getText().split("-");
                         int date=Integer.parseInt(t[0]);
                         int mon=Integer.parseInt(t[1]);
                         int year=Integer.parseInt(t[2]);
                         boolean f=true;
                         for(int i=0;i<matchDate.length;i++)
                         {
                             
                             String temp[]=matchDate[i][0].split("-");
                             int ddate=Integer.parseInt(temp[2]);
                             int dmon=Integer.parseInt(temp[1]);
                             int dyear=Integer.parseInt(temp[0]);
                             if((ddate>date)&&(dmon>=mon)&&(dyear>=year))
                             {
                                 f=false;
                                 break;
                             }
                         ...
                         {
                             String pws=javax.swing.JOptionPane.showInputDialog(this,"Please input admin password");
                             if(checkAdminId(pws))
                            {
                                return true;
                            }
                            ...
                            {
                                javax.swing.JOptionPane.showMessageDialog(null,"Sorrry ! You are input wrong password");
                                flag=false;
                                return false;
                            }
                         }
            ...
            else
            {
                ...
                qry="select status from build_distribution where dp_code="+dept_code+" and pmrno="+Integer.parseInt(jLabel5.getText())+" and status=0";
                String t=object1.getSigetngleValue(qry,Main.year);
    ...
    private void creationOfLogTable(String operation)
    {
		...
		catch(Exception e)
		{
            ...
            qry="insert into build_distribution_edit values("+Integer.parseInt(getDpCode)+",'"+setDate+"',"+Integer.parseInt(""+jTable1.getValueAt(r,2))+","+Integer.parseInt(""+jTable1.getValueAt(r,3))+","+Integer.parseInt(""+jTable1.getValueAt(r,4))+","+Integer.parseInt(getCashierCode)+",'"+(""+jTable1.getValueAt(r,6)).trim().toString()+"',"+Double.valueOf(""+jTable1.getValueAt(r,7))+",'"+(""+jTable1.getValueAt(r,8))+"','"+editDate+"','"+editTime+"','"+operation+"','"+Main.userID+"')";
