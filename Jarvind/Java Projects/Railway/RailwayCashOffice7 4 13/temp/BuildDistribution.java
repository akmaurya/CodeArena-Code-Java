...
private void loadPMR()
{
    ...
    try
    {
        ...
        int setPmr=Integer.parseInt(getStr[0]);
        String getpmr=null;
        System.out.println("setPmr..........."+setPmr);
        if(setPmr==1)
        {
...
private boolean Save()
{
   ...
   if(jTextField1.getText().trim().equals(""))
   {
    ...
    if(jTextField2.getText().trim().equals(""))
    {
     ...
     if((jComboBox2.getSelectedItem().equals("Cash n Cheque")==true) ||(jComboBox2.getSelectedItem().equals("Cheque")==true))
     {
