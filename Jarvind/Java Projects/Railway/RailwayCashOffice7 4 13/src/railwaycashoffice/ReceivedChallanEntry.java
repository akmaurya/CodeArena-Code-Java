...
public class ReceivedChallanEntry extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Receive Cash By Cashier");
        ...
        jComboBox1.setBounds(130, 70, 210, 25);
            ...
            if(bn)
            {
                ...
                if(str!=null)
                {
                    if(str.length()>0)
                    {
                        ...
                        bd=bd.subtract(new java.math.BigDecimal(jTextField1.getText().trim()));
                ...
                if(flag==false)     //it means today dc did not receive any amount.
                {
                    ...
                    if(arr!=null)
                    {
                        if (arr.length > 0)
                        {
                            java.math.BigDecimal bd=new java.math.BigDecimal(arr[0]);
                            bd=bd.subtract(new java.math.BigDecimal(jTextField1.getText().trim()));
                ...
                //now update further cash amt.
                    //----------------------------
                    qry="select cash_amt,rec_date from dc_cash_in_hand where rec_date>'"+setDate+"' order by rec_date";
                    String arr1[][]=object1.getInformationDD(qry,2, Main.year);
                    if(arr1!=null)
                    {
                        for(int r=0;r<arr1.length;r++)
                        {
                            java.math.BigDecimal bd=new java.math.BigDecimal(arr1[r][0]);
                            bd=bd.subtract(new java.math.BigDecimal(jTextField1.getText().trim()));
                            qry="update dc_cash_in_hand set cash_amt="+bd+" where rec_date='"+arr1[r][1]+"'";
                            bn=object1.saveInformation(qry, Main.year);
                        }
                    }
