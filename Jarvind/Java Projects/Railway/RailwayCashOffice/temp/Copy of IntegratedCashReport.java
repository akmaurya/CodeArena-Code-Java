...
public class IntegratedCashReport extends javax.swing.JInternalFrame {
    ...
    public IntegratedCashReport() {
       ...
       // jTextField5.setVisible(false);
        ...
        String head2[]={"Sr No.","Cashier No.","Amount"};
        ...
        column.setCellRenderer(CRLeft);
        column.setPreferredWidth(60);
        column=jTable3.getColumn("Cashier No.");
        column.setCellRenderer(CRRight);
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel8);
        jLabel8.setBounds(10, 310, 260, 25);
        ...
        jPanel2.add(jLabel9);
        jLabel9.setBounds(10, 290, 260, 20);
        ...
        jTextField4.setBounds(10, 140, 120, 25);
        ...
        jTextField5.setBounds(130, 140, 140, 25);
        ...
        jTextField6.setBounds(10, 170, 120, 25);
        ...
        jTextField7.setBounds(130, 170, 140, 25);
        ...
        jTextField8.setBounds(10, 200, 120, 25);
        ...
        jTextField9.setBounds(130, 200, 140, 25);
        ...
        jTextField10.setBounds(10, 230, 120, 25);
        ...
        jTextField11.setBounds(130, 230, 140, 25);
        ...
        jTextField12.setBounds(10, 260, 120, 25);
        ...
        jTextField13.setBounds(130, 260, 140, 25);
        ...
        jScrollPane3.setBounds(10, 340, 260, 140);
...
private void loadCashDetail()
{
    try
    {
        ...
        String qry="select cash_amt from dc_cash_in_hand  order by rec_date desc";
        String getAmt=object1.getSigetngleValue(qry,Main.year);
        if(getAmt!=null)
        {
            bd=bd.add(new java.math.BigDecimal(getAmt));
            jTextField4.setText("Cash In Hand");
            jTextField5.setText(""+bd);
            jTextField5.setForeground(java.awt.Color.magenta);
        }

        qry="Select distinct(dp_Code) from build_distribution where edate='"+setDate1+"' order by dp_Code";
        System.out.println("qry>>>>>>>"+qry);
        String getDp[]=object1.getResultSetAs_1D_Array(qry,Main.year);
        System.out.println("getDp len>>>>>"+getDp.length);
        if(getDp!=null)
        {
             bd=new java.math.BigDecimal("0");
            for(int x=0;x<getDp.length;x++)
            {
                System.out.println("getDp......shweta...."+getDp[x]);
