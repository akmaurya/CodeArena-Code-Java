...
public class DCBalanceRegister extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setBounds(150, 30, 210, 25);
        ...
        jButton1.setBounds(360, 30, 30, 25);
        ...
        jScrollPane2.setBounds(20, 20, 540, 210);
        jPanel1.add(jProgressBar2);
        jProgressBar2.setBounds(20, 230, 540, 10);
        ...
        jPanel1.add(jLabel3);
        jLabel3.setBounds(400, 380, 160, 20);
        ...
        jPanel1.add(jLabel4);
        jLabel4.setBounds(400, 260, 160, 20);
        ...
        jPanel1.add(jLabel5);
        jLabel5.setBounds(400, 290, 160, 20);
        ...
        jPanel1.add(jLabel6);
        jLabel6.setBounds(400, 320, 160, 20);
        ...
        jScrollPane3.setBounds(20, 260, 380, 170);
        ...
        jPanel1.add(jLabel8);
        jLabel8.setBounds(400, 410, 160, 20);

        getContentPane().add(jPanel1);
        jPanel1.setBounds(310, 90, 580, 470);
        ...
        jButton2.setBounds(410, 30, 240, 30);
        ...
        jPanel2.setBounds(20, 90, 280, 470);
        ...
        jButton3.setBounds(260, 570, 410, 30);
        ...
        jButton4.setBounds(660, 30, 230, 30);
    ...
    try
    {
      ...
      //  System.out.println("deadDate......"+deadDate);
        if(load!=null)
        {
            String arr[]=null;
            int ind=0,index=0;
            java.math.BigDecimal bdOpening;
            java.math.BigDecimal bdTotal;
            java.math.BigDecimal bdCRBalance;
            java.math.BigDecimal bdDue;
				...
				catch(Exception ex)
				{
					System.out.println("Error at the time of connection with server ip-rmi//127.0.0.1/railwayMethods  ..."+ex);
                             ...
                             /*/   int c=0;
                                ...
                                {
                               //      System.out.println("data1......."+data1[k][0]);
                                     arr[0]=data1[k][0];
                               ///      System.out.println("data1......."+arr[0]);
                               //     System.out.println("data1......."+data1[k][1]);
                                    arr[1]=data1[k][1];
                                 //     System.out.println("data1......."+arr[1]);
                                  //  System.out.println("data1......."+data1[k][2]);
                                    arr[2]=data1[k][2];
                                    //  System.out.println("data1......."+arr[3]);
                                  //  System.out.println("data1......."+data1[k][3]);
                                    arr[3]=data1[k][3];
                                   //   System.out.println("data1......."+arr[4]);
                                 ///   System.out.println("data1......."+data1[k][4]);
                                    arr[4]=data1[k][4];
                                ///      System.out.println("data1......."+arr[4]);
                                //    System.out.println("data1......."+data1[k][5]);
                                    arr[5]=data1[k][5];
                                  ///    System.out.println("data1......."+arr[5]);
                                 ///   System.out.println("data1......."+data1[k][6]);
                                    arr[6]=data1[k][6];
                                 ///     System.out.println("data1......."+arr[6]);
                                //    System.out.println("data1......."+data1[k][7]);
                                    arr[7]=data1[k][7];
                                ///      System.out.println("data1......."+arr[7]);
                               ///     System.out.println("data1......."+data1[k][8]);
                                    arr[8]=data1[k][8];
                                ////      System.out.println("data1......."+arr[8]);
                               //     System.out.println("data1......."+data1[k][9]);
                                    arr[9]=data1[k][9];
                                //      System.out.println("data1......."+arr[9]);
                                 //   System.out.println("data1......."+data1[k][10]);
                                    arr[10]=data1[k][10];
                                 //     System.out.println("data1......."+arr[10]);
                               ...
                               // int sumOfTableLength=data.length+data1.length;
