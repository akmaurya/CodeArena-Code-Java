...
//        addDepartmentNameInList();
        ...
        String heading[]={"Sr. No.","Date","Opening Amt.","Cleared Chq. No.","Chq. Amt.","Distributed Amt.","Balance Amt."};
        ...
        column=jTable1.getColumn("Cleared Chq. No.");
        column.setCellRenderer(CRCenter);
        column.setPreferredWidth(110);
        column=jTable1.getColumn("Chq. Amt.");
        column.setCellRenderer(CRRight);
    ...
    private void initComponents() {
        ...
        jButton2.setBounds(160, 510, 130, 30);
        ...
        jScrollPane1.setBounds(10, 60, 660, 440);
        ...
        jLabel6.setBounds(10, 20, 170, 20);
        ...
        jButton4.setBounds(540, 17, 130, 30);
        ...
        jButton5.setBounds(10, 510, 130, 30);
    ...
    private void setChequeDetails()
    {
		...
		catch(Exception ex)
		{
			System.out.println("Error at the time of connection with server ip-rmi//127.0.0.1/railwayMethods  ..."+ex);
             ...
             //if(dpCode==-1)
                 qry="select sum(chq_amt) from dc_chq_details where clearance_date<'"+setDateFrom+"' and chq_status=1  order by receiving_date desc,sq_no asc";
             //else
             //    qry="select sum(chq_amt) from dc_chq_details where clearance_date<'"+setDateFrom+"' and dp_code="+dpCode+" and chq_status=1  order by receiving_date desc,sq_no asc";
          ...
          while(dtFromLong<=dtToLong)
          {
              ...
              flag=false;
              //get details of cleared cheque amount
              //------------------------------------
             qry="select * from dc_chq_details where clearance_date='"+setDate+"' and chq_status=1  order by receiving_date,sq_no asc";
