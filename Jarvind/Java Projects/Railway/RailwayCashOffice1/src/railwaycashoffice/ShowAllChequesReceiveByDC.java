 ...
 * @author welcome
 */
public class ShowAllChequesReceiveByDC extends javax.swing.JInternalFrame {

    /** Creates new form ChequeReceiveByDC */
    public ShowAllChequesReceiveByDC() {
        initComponents();
        ...
        String heading[]={"Sr. No.","Receiving Dt.","Cheque No.","Cheque Amt.","Cheque Status","Clearance Dt."};
        ...
        column=jTable1.getColumn("Receiving Dt.");
        column.setCellRenderer(CRCenter);
        column.setPreferredWidth(110);
        column=jTable1.getColumn("Cheque No.");
        column.setCellRenderer(CRCenter);
        column.setPreferredWidth(90);
        column=jTable1.getColumn("Cheque Amt.");
        column.setCellRenderer(CRRight);
        column.setPreferredWidth(100);
        column=jTable1.getColumn("Cheque Status");
        column.setCellRenderer(CRCenter);
        column.setPreferredWidth(100);
        column=jTable1.getColumn("Clearance Dt.");
        column.setCellRenderer(CRCenter);
        column.setPreferredWidth(100);
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("REPORT :: ALL CHEQUES RECEIVED BY DC");
        ...
        jButton2.setBounds(550, 50, 120, 30);
        ...
        jScrollPane1.setBounds(10, 90, 660, 450);
    ...
    private void setChequeDetails()
    {
		...
		catch(Exception ex)
		{
          ...
          while(dtFromLong<=dtToLong)
          {
             ...
             //System.out.println(qry);
             String data[][]=object1.getInformationDD(qry, 7, Main.year);
             ...
             for(int i=0;i<data.length;i++)
             {
                 ...
                 try
                 {
                     rowArr[2]=data[i][2];//cheque no.
                     rowArr[3]=""+(new java.math.BigDecimal(data[i][3])).setScale(2,5);//received amt.
                 }
                 catch(Exception ex)
                 {
                     rowArr[2]="";
                 ...
                 if(data[i][4].equals("1"))
                 {
                     rowArr[4] = "Cleared";
                     str=data[i][6];
             String arrdt[]=str.split("-");
             rowArr[5]=arrdt[2]+"-"+arrdt[1]+"-"+arrdt[0];
