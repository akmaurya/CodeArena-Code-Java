     ...
     try
     {
		...
		catch(Exception e)
		{
			...
			catch(Exception ex)
			{
                ...
                String setDeadDate="01-1-2000";//2000+"-"+1+"-"+1;
                ...
                if(getCo7!=null)
                {
                    ...
                    {
                       qry="Select pmrno,CO6,mix_amount,amounttype,partyname,paymentdate from build_distribution where CO7="+Integer.parseInt(getCo7[i])+" and dp_code="+Integer.parseInt(getDpCode)+" and cashier_code="+Integer.parseInt(getCashierCode)+" and edate='"+setDate+"' order by bill_Code";
                       ...
                       if(loadData!=null)
                       {
                           for(int j=0;j<loadData.length;j++)
                           {
                              ...
                              String matchDate=Integer.parseInt(D1[2])+"-"+Integer.parseInt(D1[1])+"-"+Integer.parseInt(D1[0]);
