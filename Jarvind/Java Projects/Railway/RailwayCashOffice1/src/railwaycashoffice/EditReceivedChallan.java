...
public class EditReceivedChallan extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/railwaycashoffice/images/update.gif"))); // NOI18N
        ...
        jButton4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/railwaycashoffice/images/Close1.gif"))); // NOI18N
...
private void uploadDetail()
{
    try
    {
        ...
        lastReceivedCash=jTextField1.getText();
    }
...
private boolean updateRecord()
{
    try
    {
        ...
        else if(amt.length()>0)
        {
            ...
            if(bn)
            {
                java.math.BigDecimal bd1=new java.math.BigDecimal(lastReceivedCash);
                java.math.BigDecimal bd2=new java.math.BigDecimal(jTextField1.getText());
                java.math.BigDecimal bd3=bd1.subtract(bd2);//differance amount received by cashier
                qry="select cash_amt,rec_date from dc_cash_in_hand where rec_date>='"+setDate+"' order by rec_date";
                String str[][]=object1.getInformationDD(qry,2, Main.year);
                if(str!=null)
                {
                    for(int i=0;i<str.length;i++)
                    {
                        bd1=new java.math.BigDecimal(str[i][0]);
                        bd2=bd1.add(bd3);
                        qry="update dc_cash_in_hand set cash_amt="+bd2+" where rec_date='"+str[i][1]+"'";
