    ...
    try
    {
       ...
       // interfaceRailway object1=(interfaceRailway)java.rmi.Naming.lookup("rmi://127.0.0.1/railwayMethods");
        ...
        if(receivedAmt!=null)// || receivedAmt.length>0)
                  ...
                  receivedamount=0.0;
        totdue=dueAmount+amount;//+lastYearDueAmt);
...
private boolean Save()
{
    try
    {
        ...
        String qry="Select dp_code form department_detail where dp_name='"+(""+jComboBox1.getSelectedItem())+"'";
      //  System.out.println("qry.............."+qry);
        String getDpCode=object1.getSigetngleValue(qry,Main.year);
        ...
        boolean flag2;
         ...
         private void printAssets(int i)
         {
            ...
            switch(i)
            {
                ...
                case 3:
                    ...
                    init=(85+(jLabel15.getText().length()));
                    for(int s=init;s<len;s++)
                        pw.print(" ");
               ...
               case 4:
                    ...
                    init=(85+(jTextField4.getText().length()));
                    for(int s=init;s<len;s++)
                        pw.print(" ");
              ...
              case 5:
                    ...
                    init=(85+(jTextField6.getText().length()));
                    for(int s=init;s<len;s++)
                        pw.print(" ");
              ...
              case 6:
                    ...
                    init=(85+(jTextField8.getText().length()));
                    for(int s=init;s<len;s++)
                        pw.print(" ");
               ...
               case 7:
                    ...
                    init=(85+(jTextField10.getText().length()));
                    for(int s=init;s<len;s++)
                        pw.print(" ");
              ...
              case 8:
                    ...
                    init=(85+(jTextField12.getText().length()));
                    for(int s=init;s<len;s++)
                        pw.print(" ");
         ...
         private void lastAssetTotalAmtPrint()
         {
             for(int s=0;s<85;s++)
                    ...
                    int len=125-((""+jLabel8.getText()).length());
