...
public class Purchase extends JFrame implements ActionListener,MouseListener,KeyListener,FocusListener
{
	Container con;
	JInternalFrame frm;
	...
	double curBalance=0;
	JDesktopPane desk;
	JLabel billNoLb,drCrLb,drCrLb1;
	boolean updateFlag=false;	
	JComboBox drCrCb;	
	public Purchase(JDesktopPane desk)
	{
		this.desk=desk;
		frm=new JInternalFrame("Purchase 11",false,true,false,true);
		...
		tounchTf1.setBounds(140,380,100,20);
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		else if(e.getSource()==partyCb)
		{
			...
			System.out.print("inside event1");
			String str=partyCb.getSelectedItem().toString();
			System.out.print("inside event2");
			reset();
			System.out.print("inside event3");
			partyCb.setSelectedItem(str);
			System.out.print("inside event4");
			getLastBalance();
			System.out.print("inside event5");
			}
			catch(Exception x)
			{
	...
	public void keyReleased(KeyEvent e)
	{
		...
		{
			if((e.getKeyCode()>=48 && e.getKeyCode()<=57) || e.getKeyCode()==46 || e.getKeyCode()==8){}
			else
			{
		...
		try
		{
			System.out.println("OK");
        		    ...
        		    if(rs.next())
        		    {
        		    	...
        		    	System.out.println("select * from Purchase_x where p_s_no="+Integer.parseInt(billNoLb.getText())+"");
        		    	rs=st.executeQuery("select * from Purchase_x where p_s_no="+Integer.parseInt(billNoLb.getText())+"");
        		    	if(rs.next())
        		    	{
        		    		totalPurWtL.setText(rs.getString("field1"));
