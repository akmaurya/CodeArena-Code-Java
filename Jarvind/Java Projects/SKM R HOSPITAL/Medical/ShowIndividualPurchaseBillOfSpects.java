 ...
 */
public class ShowIndividualPurchaseBillOfSpects extends javax.swing.JInternalFrame {
    
    /** Creates new form MakingPurchaseOfSpects */
    public ShowIndividualPurchaseBillOfSpects(javax.swing.JDesktopPane jDesktopPane1,int pNo,String callFrom) {
    	System.out.println("Purchase Bill of Spects");
        initComponents();
         this.pNo=pNo;
...
//        jPanel3.add(jButton3);
    ...
    //jButton5.setBounds(290, 5, 130, 30);
    jButton5.setBounds(200, 5, 330, 30);
...
catch(Exception e)
{
	...
	catch(Exception ex)
	{
		System.out.println("Error with connection with server  rmi://127.0.0.1/ExtendZedServer...");
				...
				query="insert into purchaseSmryOfSpects values("+pno+",#"+entrydate+"#,'"+""+jComboBox1.getSelectedItem()+"','"+jTextArea1.getText()+"','"+jTextField1.getText()+"','"+jTextField2.getText()+"',"+Double.valueOf(jLabel15.getText())+",'"+""+jComboBox6.getSelectedItem()+"')";
				inf.executeUpdateQuery(query);
				inf.executeUpdateQuery("insert into purchasePaymentSmry values("+pno+",'"+""+jComboBox1.getSelectedItem()+"','"+jTextField1.getText()+"','"+jTextField2.getText()+"',"+Double.valueOf(jLabel15.getText())+","+Double.valueOf(jLabel15.getText())+")");
			//	int quantity=0;
			...
			/*	query="Select qty from purchaseDtlOfSpects where  groupCode="+gpcode+" and catCode="+catcode+" and itmCode="+itmcode+" and cmpCode="+cmpcode+"";
				...
				int quanty=0;
					String qry="Select qty from spectsStockHolding where cmpCode="+cmpcode+" and itmCode="+itmcode+" and size_lense_No='"+size_lens+"'";
