...
public class ChangePassword extends javax.swing.JInternalFrame {
    ...
    public ChangePassword(javax.swing.JDesktopPane jDesktopPane1) {
        initComponents();
...
catch(Exception e)
{
	...
	catch(Exception ex)
	{
		System.out.println("Error with connection with server  rmi://127.0.0.1/ExtendZedServer...");
            ...
            {
                String qry="select uPws from loginMasterOfMedical where uPws='"+ps+"' and uId='"+tf1.getText()+"'";
                String rs=inf.getSingleValue(qry);
                if(rs!=null)
                {
                    inf.executeUpdateQuery("update loginMasterOfMedical set uPws='"+newps+"' where uId='"+tf1.getText()+"'");
