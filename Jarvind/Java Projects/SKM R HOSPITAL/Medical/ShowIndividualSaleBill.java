 ...
 * @author  Deep Pal
 */
public class ShowIndividualSaleBill extends javax.swing.JInternalFrame {
    
    /** Creates new form MakingSale */
    public ShowIndividualSaleBill(javax.swing.JDesktopPane jDesktopPane1,int sNo,String callFrom) {
        initComponents();
        this.sNo=sNo;
...
catch(Exception e)
{
	...
	catch(Exception ex)
	{
        ...
        try
        {
            ...
            String qry="";
            if(callFrom.equalsIgnoreCase("saleSmry"))
            {
                qry="select sNo from saleSmry where sNo="+sNo;
            }
            else if(callFrom.equalsIgnoreCase("saleSmryEdit"))
            {
                qry="select sNo from saleSmryEdit where editNo="+sNo;
            }
            ZedInterface inf=null;
ZedInterfaceForMedical uc=null;
try
...
catch(Exception e)
{
	...
	catch(Exception ex)
	{
		System.out.println("Error with connection with server  rmi://127.0.0.1/ExtendZedServer...");
            ...
            jLabel33.setText(inf.getSingleValue(qry));
            //String str[][]=uc.returnResultSet(qry,"EditMakePurchaseWindowSmry","");
            //jLabel33.setText(str[0][0]);
    ...
    private void setExistingData()
    {
        try
        {
            ...
            if(callFrom.equalsIgnoreCase("saleSmry"))
            {
                qry="select sNo,entrydt,totalitems,dispc,taxpc,totalAmt,disAmt,taxAmt,payAmt,netAmt from saleSmry where sNo="+sNo;
            }
            else if(callFrom.equalsIgnoreCase("saleSmryEdit"))
            {
                qry="select sNo,entrydt,totalitems,dispc,taxpc,totalAmt,disAmt,taxAmt,payAmt,netAmt from saleSmryEdit where editNo="+sNo;
            }
...
catch(Exception e)
{
		...
		System.out.println("Error with connection with server  rmi://127.0.0.1/ExtendZedServer...");
            ...
            if(rs!=null)
            {
                ...
                if(callFrom.equalsIgnoreCase("saleSmry"))
                {
                    ...
                    qry="Select coNm,batchNo,expDt,itemNm,qty,qtytype,mrp,amount from saleDtl where sNo="+sNo; 
                 }
                 else if(callFrom.equalsIgnoreCase("saleSmryEdit"))
                {
                     qry="select * from saleDtlEdit where sNo="+sNo;
                }
                //rs=st.executeQuery(qry);
                ...
                /////update by S_CHK/////////
                  String rr[][]=inf.getResultSetAs_2D_Array(qry,8);
                if(rr!=null)
                for(int i1=0;i1<rr.length;i1++)
                {
                    String arr[]=new String[9];
    ...
    private void initComponents() {
        ...
        jPanel2.setBounds(480, 130, 290, 170);
        ...
        jLabel6.setBounds(350, 100, 60, 20);
        ...
        jButton1.setBounds(690, 90, 40, 30);
        ...
        jButton5.setBounds(20, 430, 400, 30);
        ...
        jButton6.setBounds(740, 90, 30, 29);
        ...
        jButton8.setBounds(20, 380, 400, 30);
...
// TODO add your handling code here:
        if(evt.getKeyCode()==10)    printBill();
...
catch(Exception e)
{
	...
	catch(Exception ex)
	{
		System.out.println("Error with connection with server  rmi://127.0.0.1/ExtendZedServer...");
        	...
        	unittype=uc.getSmallestQtyType(jTextField5.getText().trim());//,jTextField5.getText().trim());
		}
        catch(Exception ex)
		{
     		System.out.println("Error ...."+ex);
