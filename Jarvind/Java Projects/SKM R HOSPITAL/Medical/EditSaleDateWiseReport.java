 ...
 * @author  Deep Pal
 */
public class EditSaleDateWiseReport extends javax.swing.JInternalFrame {
    
    /** Creates new form ListOfPurchaseing */
    public EditSaleDateWiseReport(javax.swing.JDesktopPane jDesktopPane1) {
        initComponents();
        ...
        String heading[]={"S.No.","EditNo.","eDate","eTime","Bill No.","Total Items","Total Amt.","Discount","Tax","Net Amt."};
...
catch(Exception e)
{
	...
	catch(Exception ex)
	{
		System.out.println("Error with connection with server  rmi://127.0.0.1/ExtendZedServer...");
            ...
            String query="select sNo,totalitems,totalAmt,disAmt,taxAmt,netAmt,editNo from saleSmryEdit";
		...
		rs=inf.getResultSetAs_2D_Array(query,7);
            ...
            for(int i=0;i<rs.length;i++) {
                ...
                arr[4]=rs[i][0];
                arr[5]=rs[i][1];
                arr[6]=""+(new java.math.BigDecimal(rs[i][2])).setScale(2,5);
                temp=Double.valueOf(rs[i][3]);
                arr[7]=""+(new java.math.BigDecimal(temp)).setScale(2,5);
                tDisAmt+=temp;
                temp=Double.valueOf(rs[i][4]);
                arr[8]=""+(new java.math.BigDecimal(temp)).setScale(2,5);
                tTaxAmt+=temp;
                ...
                //u..java.text.SimpleDateFormat sdf=new java.text.SimpleDateFormat("dd/MM/yyyy");
                arr[2]=(dbDate);//u.
            ...
            //connection.close();
            if(flag==0) {
                javax.swing.JOptionPane.showMessageDialog(this,"Oh!\nNo edit sale bill found.","Information",javax.swing.JOptionPane.INFORMATION_MESSAGE);
...
catch(Exception e)
{
	...
	catch(Exception ex)
	{
        ...
        else
        {
            ...
            ShowIndividualSaleBill emp=new ShowIndividualSaleBill(jDesktopPane1,sno,"saleSmryEdit");
        }
        }
        catch(Exception e)
        {
