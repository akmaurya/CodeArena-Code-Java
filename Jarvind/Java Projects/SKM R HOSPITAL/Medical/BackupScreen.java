 ...
 */
 import java.rmi.*;
public class BackupScreen extends javax.swing.JInternalFrame implements Runnable{
    
    /** Creates new form BackupScreen */
    public BackupScreen(javax.swing.JDesktopPane jDesktopPane1) {
        initComponents();
...
catch(Exception e)
{
	...
	try
	{
		obj1=(ZedInterface)Naming.lookup("rmi://127.0.0.1/ExtendZedServer");
		inf1=(ZedInterfaceForMedical)Naming.lookup("rmi://127.0.0.1/ExtendZedServer");
	}
	catch(Exception ex)
	{
