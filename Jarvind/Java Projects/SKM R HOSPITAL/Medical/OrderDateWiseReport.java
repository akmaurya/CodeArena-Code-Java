 ...
 * @author  Deep Pal
 */
public class OrderDateWiseReport extends javax.swing.JInternalFrame {
    
    /** Creates new form ListOfPurchaseing */
    public OrderDateWiseReport(javax.swing.JDesktopPane jDesktopPane1) {
        initComponents();
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Order Report - Date Wise");
        ...
        jScrollPane1.setBounds(10, 60, 760, 290);
        ...
        jCheckBox1.setToolTipText("Select me to give first date");
...
catch(Exception e)
{
	...
	catch(Exception ex)
	{
		...
		query+=" where orderDt>=#"+selectedDate1+"# and orderDt<=#"+selectedDate2+"# order by orderDt,oNo";
                System.out.println("Query="+query);
		rs=inf.getResultSetAs_2D_Array(query,4);
				}
            if(!jCheckBox1.isSelected())
            {
		System.out.println("3.........");
		query+=" where orderDt<=#"+selectedDate2+"# order by orderDt,oNo";
                System.out.println("Query="+query);
		rs=inf.getResultSetAs_2D_Array(query,4);
            }
            ...
            for(int i=0;i<rs.length;i++) {
                ...
                arr[2]=rs[i][1];
                arr[3]=rs[i][2];
                int status=Integer.parseInt(rs[i][3]);
                if(status==0)
                {
                    arr[4]="Pending";
                }
            ...
            //connection.close();
            if(flag==0) {
                javax.swing.JOptionPane.showMessageDialog(this,"Oh!\nNo order bill found.","Information",javax.swing.JOptionPane.INFORMATION_MESSAGE);
...
catch(Exception e)
{
	...
	catch(Exception ex)
	{
        ...
        {
            int orderNo=Integer.parseInt(""+vc.elementAt(jTable1.getSelectedRow()));
        ShowIndividualOrderBill emp=new ShowIndividualOrderBill(jDesktopPane1,orderNo);
        }
        }
        catch(Exception ex)
		{
