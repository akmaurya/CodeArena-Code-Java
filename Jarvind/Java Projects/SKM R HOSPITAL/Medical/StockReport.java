...
public class StockReport extends javax.swing.JInternalFrame {
    ...
    public StockReport(javax.swing.JDesktopPane jDesktopPane1) {
        initComponents();
        dp=jDesktopPane1;
        try
        {
	...
	catch(Exception ex)
	{
		System.out.println("Error with connection with server  rmi://127.0.0.1/ExtendZedServer...");
            ...
            for(int i=0;i<rs.length;i++)
            {
                ...
                {
                    itmName=rs1[j][0];
                    sqlQry="select qty,itemType,batchNo,expDate from stockHolding where itemCode="+Integer.parseInt(rs1[j][1])+" and qty>0";
