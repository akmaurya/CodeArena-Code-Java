 ...
 * @author  Deep Pal
 */
public class ListOfOrdering extends javax.swing.JInternalFrame {
    
    /** Creates new form ListOfPurchaseing */
    public ListOfOrdering(javax.swing.JDesktopPane jDesktopPane1) {
        initComponents();
        ...
        String heading[]={"S.No.","Order No.","Party Name","Total Items"};
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Edit Order Bill :: Wizard 1/2");
...
catch(Exception e)
{
	...
	catch(Exception ex)
	{
		System.out.println("Error with connection with server  rmi://127.0.0.1/ExtendZedServer...");
            ...
            String qry="select oNo,partyNm,totalItems from orderSmry where orderDt=#"+selectedDate+"# order by oNo";
...
catch(Exception e)
{
	...
	catch(Exception ex)
	{
        ...
        else
        {
            ...
            EditMakeOrder emp=new EditMakeOrder(jDesktopPane1,orderNo);
        }
        }
        catch(Exception ex)
		{
