 ...
 * @author  Deep Pal
 */
public class MakingSale extends javax.swing.JInternalFrame {
	
    /** Creates new form MakingSale */
    public MakingSale(javax.swing.JDesktopPane jDesktopPane1) {
        initComponents();
...
catch(Exception e)
{
    ...
    private void initComponents() {
        ...
        jLabelNm.setFont(new java.awt.Font("Arial", 1, 11));
        jLabelNm.setText("Customer Name");
        getContentPane().add(jLabelNm);
        jLabelNm.setBounds(170, 10, 100, 20);
        
        
        getContentPane().add(jTextFieldNm);
        jTextFieldNm.setBounds(265, 10, 150, 20);
        ...
        jLabelAddr.setFont(new java.awt.Font("Arial", 1, 11));
        jLabelAddr.setText("Address");
        getContentPane().add(jLabelAddr);
        jLabelAddr.setBounds(430, 10, 90, 20);
        
        
        getContentPane().add(jTextFieldAddr);
      //  javax.swing.JScrollPane jsp=new javax.swing.JScrollPane(jTextAreaAddr);
      //  getContentPane().add(jsp);
        jTextFieldAddr.setBounds(490,10,100,20);
        jTextFieldAddr.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                jTextFieldAddrKeyPressed(evt);
            }
        });
      ...
      jLabel34.setBounds(600, 10, 40, 20);
      ...
      jLabel35.setBounds(625, 10, 130, 20);
       ...
       jButton7.setBounds(760, 10, 20, 20);
...
// TODO add your handling code here:
    ...
    private void jTextFieldNmKeyPressed(java.awt.event.KeyEvent evt)
    {
    	if(evt.getKeyCode()==10)
    	{
    		jTextFieldAddr.requestFocus();
    	}
    	
    }
    private void jTextFieldAddrKeyPressed(java.awt.event.KeyEvent evt)
    {
    	if(evt.getKeyCode()==10)
    	{
	...
	catch(Exception ex)
	{
		System.out.println("Error with connection with server  rmi://127.0.0.1/ExtendZedServer...");
            ...
            //ZedInterface inf=(ZedInterface)Naming.lookup(getIPaddress.IP());
						...
						String query="insert into patient_All_Invoice values("+max+",#"+entrydate+"#,-1,'Through Medical(Direct)',"+netamt+",0)";
            ...
            for(int r=0;r<dtm1.getRowCount();r++)
            {
                ...
                inf.executeUpdateQuery("insert into saleDtl values("+sno+",'"+jTextFieldNm.getText().trim()+"','"+jTextFieldAddr.getText().trim()+"','"+coname+"','"+btno+"','"+expdate+"','"+itemnm+"',"+qty+",'"+pkgtype+"',"+mrp+","+amt+")");
                int itemcode=0;
                String typeofitem="";
    ...
    private void printBill()
	{
	    try
		{
           ...
           /* line="Name    : "+tf_custName.getText().toUpperCase();
            ...
            line="Customer Name:"+jTextFieldNm.getText().trim();
            pw.print(line);
         ...
         // line="Date     : "+jLabel35.getText();
          ...
          /*  rep=18;
            ...
            pw.println(line);
             ...
             line="Address      :"+jTextFieldAddr.getText().trim();
            pw.println(line);
