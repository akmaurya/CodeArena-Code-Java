 ...
 */
public class EditProvideSpectsToPatient extends javax.swing.JInternalFrame {
    
    /** Creates new form ProvideSpectsToPatient */
    public EditProvideSpectsToPatient(JDesktopPane jDesktopPane1) {
        initComponents();
        ...
        int pNo=0;
        String pid=JOptionPane.showInputDialog(null,"Enter Patient ID To Edit");
        if(pid!=null)
        {
        	try
        	{
        ...
        try
            ...
            if(arr!=null)
            {
            	...
            	setTitle("Editing Of Provide Spectacles To "+""+patientID+"#"+arr);
            }
            else
            {
...
try
    ...
    private void showInitialInfo()
    {
    	...
    	try
    		...
    		String qry="select * from patient_SpectsProvidation where pID="+patientid+" order by srno desc";
    		String arr[][]=inf.getResultSetAs_2D_Array(qry,18);
    		if(arr!=null)
    		{
    			//getting frame category---
    			int fcatcode=Integer.parseInt(arr[0][3]);
    			...
    			int fitemcode=Integer.parseInt(arr[0][4]);
    			jComboBox2.setSelectedItem(""+inf.getSingleValue("select itmNm from spectsItemMaster where itmCode="+fitemcode+""));
    			//getting frame company---
    			int fccode=Integer.parseInt(arr[0][5]);
    			jComboBox3.setSelectedItem(""+inf.getSingleValue("select cmpName from spectsCmpMaster where cmpCode="+fccode+""));
    			//getting frame size---
    			if(arr[0][6]==null)
    				arr[0][6]="";
    			jTextField1.setText(arr[0][6]);
    			//getting frame charge---
    			if(arr[0][7]==null)
    				arr[0][7]="";
    			ppp.jTextField1.setText(""+(new java.math.BigDecimal(arr[0][7]).setScale(2,java.math.BigDecimal.ROUND_HALF_UP)));
    			
    			
    			//getting glass category---
    			int gcatcode=Integer.parseInt(arr[0][8]);
    			jComboBox4.setSelectedItem(""+inf.getSingleValue("select catNm from spectsCatMaster where catCode="+gcatcode+""));
    			//getting frame related item---
    			int gitemcode=Integer.parseInt(arr[0][9]);
    			jComboBox5.setSelectedItem(""+inf.getSingleValue("select itmNm from spectsItemMaster where itmCode="+gitemcode+""));
    			//getting frame company---
    			int gccode=Integer.parseInt(arr[0][10]);
    			jComboBox6.setSelectedItem(""+inf.getSingleValue("select cmpName from spectsCmpMaster where cmpCode="+gccode+""));
    			//getting lense no----
    			if(arr[0][11]==null)
    				arr[0][11]="";
    			jTextField2.setText(arr[0][11]);
    			//getting glass charge---
    			if(arr[0][12]==null)
    				arr[0][12]="";
    			ppp.jTextField2.setText(""+(new java.math.BigDecimal(arr[0][12]).setScale(2,java.math.BigDecimal.ROUND_HALF_UP)));
    			
    			//getting extra charge---
    			if(arr[0][13]==null)
    				arr[0][13]="";
    			ppp.jTextField3.setText(""+(new java.math.BigDecimal(arr[0][13]).setScale(2,java.math.BigDecimal.ROUND_HALF_UP)));
    			
    			//getting given date--
    			String tmp[]=arr[0][14].split("-");
    			...
    			if(arr[0][15]==null)
    				arr[0][15]="";
    			ppp.jLabel6.setText(""+(new java.math.BigDecimal(arr[0][15]).setScale(2,java.math.BigDecimal.ROUND_HALF_UP)));
    			
    			//getting due amt
    			if(arr[0][16]==null)
    				arr[0][16]="";
    			ppp.jLabel10.setText(""+(new java.math.BigDecimal(arr[0][16]).setScale(2,java.math.BigDecimal.ROUND_HALF_UP)));
    			
    			//getting advanced payment---
    			double tmp1=((Double.valueOf(arr[0][15]))-(Double.valueOf(arr[0][16])));
    ...
    private boolean checkingAtOpeningTime()
    {
    	...
    	try
    		...
    		String qry="select srno from patient_SpectsProvidation where pID="+patientid+" and status="+false+"";
...
try
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Editing Of Giving Spectacles To Patient");
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/delete.gif")));
...
try
					...
					String query="delete * from patient_SpectsProvidation where srno="+serialno+"";
...
try
					...
					int itmcodeF=0;
					temp=inf.getSingleValue("select itmCode from spectsItemMaster where itmNm='"+""+jComboBox2.getSelectedItem()+"'");
					if(temp!=null)
        			...
        			inf.executeUpdateQuery("delete * from patient_SpectsProvidation where srno="+max+"");
