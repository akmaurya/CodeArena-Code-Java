 ...
 * @author  Deep Pal
 */
public class ListOfSaleing extends javax.swing.JInternalFrame {
    
    /** Creates new form ListOfPurchaseing */
    public ListOfSaleing(javax.swing.JDesktopPane jDesktopPane1) {
        initComponents();
        ...
        String heading[]={"S.No.","Bill No.","Total Items","Net Amt."};
        ...
        reshape(((dm.width-800)/2)-75,(dm.height-400)/2,630,355);
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Edit Sale Bill :: Wizard 1/2");
        ...
        jButton2.setBounds(220, 20, 130, 30);
        ...
        jButton3.setBounds(500, 20, 100, 30);
        ...
        jScrollPane1.setBounds(10, 60, 590, 250);
        ...
        jButton4.setBounds(360, 20, 130, 30);
...
catch(Exception e)
{
	...
	catch(Exception ex)
	{
		System.out.println("Error with connection with server  rmi://127.0.0.1/ExtendZedServer...");
            ...
            String qry="select sNo,totalitems,netAmt from saleSmry where entryDt=#"+selectedDate+"# order by sNo";
            String [][]rs=inf.getResultSetAs_2D_Array(qry,3);
            if(rs!=null)
...
catch(Exception e)
{
	...
	catch(Exception ex)
	{
        ...
        else
        {
            ...
            EditMakingSale emp=new EditMakingSale(jDesktopPane1,sno);
        }
        }
        catch(Exception ex)
		{
