 ...
 * @author  Deep Pal
 */
public class CmpMasterOfSpects extends javax.swing.JInternalFrame {
    
    /** Creates new form CmpMaster */
    
    public CmpMasterOfSpects(javax.swing.JDesktopPane jDesktopPane1) {
        initComponents();
        ...
        setVisible(true);
        System.out.println("Company master of Spects");
    }
...
catch(Exception e)
{
	...
	catch(Exception ex)
	{
		System.out.println("Error with connection with server  rmi://127.0.0.1/ExtendZedServer...");
            ...
            String arr[]=inf.getResultSetAs_1D_Array("select cmpName from spectsCmpMaster order by cmpName");
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Company Master : Spectacles");
...
catch(Exception e)
{
	...
	catch(Exception ex)
	{
		System.out.println("Error with connection with server  rmi://127.0.0.1/ExtendZedServer...");
                ...
                inf.executeUpdateQuery("update spectsCmpMaster set cmpName='"+jTextField1.getText().trim().toUpperCase()+"' where cmpName='"+vc.elementAt(jList1.getSelectedIndex()).toString()+"'");
...
catch(Exception e)
{
	...
	catch(Exception ex)
	{
		System.out.println("Error with connection with server  rmi://127.0.0.1/ExtendZedServer...");
                ...
                inf.executeUpdateQuery("delete * from spectsCmpMaster where cmpName='"+vc.elementAt(jList1.getSelectedIndex()).toString()+"'");
...
catch(Exception e)
{
	...
	catch(Exception ex)
	{
		System.out.println("Error with connection with server  rmi://127.0.0.1/ExtendZedServer...");
			...
			String cmp=inf.getSingleValue("select * from spectsCmpMaster where cmpName='"+jTextField1.getText().trim()+"'");
...
catch(Exception e)
{
	...
	catch(Exception ex)
	{
		...
		int cmpCode=inf.getMaxValue("select max(cmpCode) from spectsCmpMaster");
		cmpCode+=1;
		inf.executeUpdateQuery("insert into spectsCmpMaster values('"+jTextField1.getText().trim().toUpperCase()+"',"+cmpCode+")");
        //st.executeUpdate("insert into cmpMaster values('"+jTextField1.getText().trim().toUpperCase()+"',"+cmpCode+")");
        javax.swing.JOptionPane.showMessageDialog(null,"Congratulation!\nNew Company created successfully.");
        jTextField1.setText("");
        jTextField1.requestFocus();
