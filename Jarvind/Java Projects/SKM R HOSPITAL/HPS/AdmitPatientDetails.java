...
public class AdmitPatientDetails implements ActionListener,KeyListener
{	
...
//	ZedInterface zedint;
	...
	public AdmitPatientDetails(JDesktopPane desk)
	{	
		jtf=new JInternalFrame("Admit Patient Details",false,true,false,true);
		...
		String head[]={"S.No.","Admit Date","PID","Name","Related With","Ward","Room No.","Bed No."};
		...
		column=jt.getColumn("Admit Date");
      		column.setCellRenderer(CRCenter);
