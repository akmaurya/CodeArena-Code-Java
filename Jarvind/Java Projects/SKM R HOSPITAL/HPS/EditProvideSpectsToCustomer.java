 ...
 */
public class EditProvideSpectsToCustomer extends javax.swing.JInternalFrame {
    
    /** Creates new form ProvideSpectsToPatient */
    public EditProvideSpectsToCustomer(JDesktopPane jDesktopPane1) {
    	System.out.println("this is the file");
        initComponents();
        jButton4.setEnabled(false);
        r=new Refraction();
      //  r.setBounds(10,250,430,175);
      	r.setBounds(10,240,430,175);
        this.getContentPane().add(r);
        r.show();
        ppp=new PanelOfProvideSpectsToPatient();
      //  ppp.setBounds(447,10,154,353);
      ppp.setBounds(447,60,154,353);
        this.getContentPane().add(ppp);
        ppp.show();
        boolean flag=true,flag1=true;
        //int pNo=0;
        String pNo="";
        String pid=JOptionPane.showInputDialog(null,"Enter Customer ID");
        if(pid!=null)
        {
        	try
        	{
        	...
        	{
        		System.out.println("Error in constuctor of EditProvideSpectsToCustomer class...."+e);
        		flag=false;
        	}
        }
        if(flag)
        ...
        try
        	...
        	String qry="select cID from customer_SpectsProvidation where cID='"+pNo+"'";
        	System.out.println("qry............."+qry);
            String arr=inf2.getSingleValue("select cID from customer_SpectsProvidation where cID='"+pNo+"'");
            System.out.println("cid........"+arr);
            if(arr!=null)
            {
            //	int patientID=pNo;
            String patientID=pNo;
            	patientid=patientID;
            	loadarr=inf2.getResultSetAs_2D_Array("select cID,cName from customer_SpectsProvidation where cID='"+patientID+"'",2);
            	//lbl_Label.setText(""+patientID+"#"+arr);
            	setTitle("Provide Spectacles To "+""+patientID+"#"+loadarr[0][1]);
...
try
        ...
        /*	String qry="Select Count(cID) from customer_SpectsProvidation";
        	String getLastId=inf.getSingleValue(qry);
        	int convrt=Integer.parseInt(getLastId);
        	System.out.println("getLastId  "+getLastId);
        	if(getLastId.equals("0"))
        	{
        		Cid="C"+1;
        	...
        	jLabel10.setText(loadarr[0][0]);
        	jTextField3.setText(loadarr[0][1]);
    	...
    	catch(Exception e)
    	{
    		...
    		if(checkingAtOpeningTime())
    		{
    			//reshape(50,100,621,470);
        	reshape(50,100,621,513);
    ...
    private boolean checkingAtOpeningTime()
    {
    	try
    	{
    	///	ZedInterface inf=(ZedInterface)Naming.lookup(getIPaddress.IP());
    	try
    		...
    		String qry="select srno from customer_SpectsProvidation where cID='"+patientid+"'"+" and status="+false+"";
    		String sno=inf.getSingleValue(qry);
    		if(sno!=null)
    		{
    			serialno=Integer.parseInt(sno);
    			return true;
    	...
    	{
    		System.out.println("Error in checkingAtOpeningTime method of EditProvideSpectsToPatient class...."+e);
    		return false;
    	}
    }
...
try
      ...
      private void showInitialInfo()
    {
    	...
    	try
    		...
    		String qry="select * from customer_SpectsProvidation where cID='"+patientid+"' order by srno desc";
    		String arr[][]=inf.getResultSetAs_2D_Array(qry,19);
    		if(arr!=null)
    		{
    			//getting frame category---
    			int fcatcode=Integer.parseInt(arr[0][4]);
    			jComboBox1.setSelectedItem(""+inf.getSingleValue("select catNm from spectsCatMaster where catCode="+fcatcode+""));
    			//getting frame related item---
    			int fitemcode=Integer.parseInt(arr[0][5]);
    			jComboBox2.setSelectedItem(""+inf.getSingleValue("select itmNm from spectsItemMaster where itmCode="+fitemcode+" and catCode="+fcatcode+""));
    			//getting frame company---
    			int fccode=Integer.parseInt(arr[0][6]);
    			jComboBox3.setSelectedItem(""+inf.getSingleValue("select cmpName from spectsCmpMaster where cmpCode="+fccode+""));
    			//getting frame size---
    			if(arr[0][7]==null)
    				arr[0][7]="";
    			jTextField1.setText(arr[0][7]);
    			//getting frame charge---
    			if(arr[0][8]==null)
    				arr[0][8]="";
    			ppp.jTextField1.setText(""+(new java.math.BigDecimal(arr[0][8]).setScale(2,java.math.BigDecimal.ROUND_HALF_UP)));
    			
    			
    			//getting glass category---
    			int gcatcode=Integer.parseInt(arr[0][9]);
    			jComboBox4.setSelectedItem(""+inf.getSingleValue("select catNm from spectsCatMaster where catCode="+gcatcode+""));
    			//getting frame related item---
    			int gitemcode=Integer.parseInt(arr[0][10]);
    			jComboBox5.setSelectedItem(""+inf.getSingleValue("select itmNm from spectsItemMaster where itmCode="+gitemcode+""));
    			//getting frame company---
    			int gccode=Integer.parseInt(arr[0][11]);
    			jComboBox6.setSelectedItem(""+inf.getSingleValue("select cmpName from spectsCmpMaster where cmpCode="+gccode+""));
    			//getting lense no----
    			if(arr[0][12]==null)
    				arr[0][12]="";
    			jTextField2.setText(arr[0][12]);
    			//getting glass charge---
    			if(arr[0][13]==null)
    				arr[0][13]="";
    			ppp.jTextField2.setText(""+(new java.math.BigDecimal(arr[0][13]).setScale(2,java.math.BigDecimal.ROUND_HALF_UP)));
    			
    			//getting extra charge---
    			if(arr[0][14]==null)
    				arr[0][14]="";
    			ppp.jTextField3.setText(""+(new java.math.BigDecimal(arr[0][14]).setScale(2,java.math.BigDecimal.ROUND_HALF_UP)));
    			
    			//getting given date--
    			String tmp[]=arr[0][15].split("-");
    			String dt[]=tmp[2].split(" ");
    			String givendt=dt[0]+"/"+tmp[1]+"/"+tmp[0];
    			ppp.jLabel8.setText(givendt);
    			
    			//getting Total amt
    			if(arr[0][16]==null)
    				arr[0][16]="";
    			ppp.jLabel6.setText(""+(new java.math.BigDecimal(arr[0][16]).setScale(2,java.math.BigDecimal.ROUND_HALF_UP)));
    			
    			//getting due amt
    			if(arr[0][17]==null)
    				arr[0][17]="";
    			ppp.jLabel10.setText(""+(new java.math.BigDecimal(arr[0][17]).setScale(2,java.math.BigDecimal.ROUND_HALF_UP)));
    			
    			//getting advanced payment---
    			double tmp1=((Double.valueOf(arr[0][16]))-(Double.valueOf(arr[0][17])));
    			ppp.jTextField4.setText(""+(new java.math.BigDecimal(tmp1).setScale(2,java.math.BigDecimal.ROUND_HALF_UP)));
    			
    		}
    	}
    	catch(Exception e)
    	{
    		System.out.println("Error in setInitInfo method of EditProvideSpectsToPatient class...."+e);
    	}
    }
...
try
    ...
    private void initComponents() {
		...
		jLabel10 =new javax.swing.JLabel("",JLabel.CENTER);
        ...
        setClosable(true);
        setTitle("Giving Spectacles To Customer");
      ...
      //  jPanel1.setBounds(10, 10, 430, 80);
  		jPanel1.setBounds(10, 60, 430, 80);
     ...
     jPanel2.setBounds(10, 150, 430, 80);
        ...
        jButton2.setText("Cancelled");
        jButton2.setToolTipText("Canel Entry");
        ...
        jButton2.setBounds(300, 10, 130, 30);
       ...
       jPanel3.setBounds(10, 420 , 590, 50);
       
       getContentPane().add(jPanel4);
       jPanel4.setBounds(10,10,593,43);
       
       jPanel4.setLayout(null);

        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(204, 0, 0), 1, true), "Customer info", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(0, 0, 153)));
       
       jLabel9.setFont(new java.awt.Font("Times New Roman", 0, 14));
        jLabel9.setText("Customer ID");
        jPanel4.add(jLabel9);
        jLabel9.setBounds(10, 15, 100, 20);
       	
       //	jPanel4.add(jLabel401);
       	
       jLabel10.setFont(new java.awt.Font("Times New Roman", 1, 15));
       jLabel10.setOpaque(true);
       jLabel10.setBackground(new java.awt.Color(0,0,225));
      
       
        jPanel4.add(jLabel10);
         jLabel10.setForeground(new java.awt.Color(255,255,255));
      //  jLabel10.setText(""+Cid);
        jLabel10.setBounds(111, 15, 100, 20);

		jLabel11.setFont(new java.awt.Font("Times New Roman", 0, 14));
        jLabel11.setText("Customer Name");
        jPanel4.add(jLabel11);
        jLabel11.setBounds(225, 15, 100, 23);
        ...
        jTextField3.setBounds(325, 15, 253, 20);
...
// TODO add your handling code here:
	if((jTextField3.getText().trim()).equals(""))
		javax.swing.JOptionPane.showMessageDialog(this,"ERROR !\nPlease Enter The Customer's Name","Message",javax.swing.JOptionPane.ERROR_MESSAGE);
	else
        save();
...
try
					...
					int max=0;
					/*max=inf.getMaxValue("select max(srno) from patient_SpectsProvidation");
					max+=1;*/
					max=serialno;
					//-----frame dtl
					int catcodeF=0;
					...
					int itmcodeG=0;
					temp=inf.getSingleValue("select itmCode from spectsItemMaster where itmNm='"+""+jComboBox5.getSelectedItem()+"'");
					if(temp!=null)
        			...
        			//deleting prevoius info----------
        			inf.executeUpdateQuery("delete * from customer_SpectsProvidation where srno="+max+"");
        			//inserting related info -----
					String query="insert into customer_SpectsProvidation values("+max+",'"+jLabel10.getText()+"','"+jTextField3.getText().trim()+"',#"+curDt+"#,"+catcodeF+","+itmcodeF+","+cmpcodeF+",'"+size+"',"+frameAmt+","+catcodeG+","+itmcodeG+","+cmpcodeG+",'"+lens+"',"+glassAmt+","+extraAmt+",#"+givenDt+"#,"+totalAmt+","+dueAmt+","+false+")";
					inf.executeUpdateQuery(query);
					javax.swing.JOptionPane.showMessageDialog(this,"Data Updated Successfully.","CONGRATS !!!",javax.swing.JOptionPane.INFORMATION_MESSAGE);
...
// TODO add your handling code here:
    ...
    private void jTextField3KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField2KeyPressed
// TODO add your handling code here:
        if(evt.getKeyCode()==10)
        {
...
try
    	...
    	private void cancelEntry()
	{
		try
		{
			int res=JOptionPane.showConfirmDialog(null,"Are You Sure To Cancel Spectacles Entry?");
			if(res==JOptionPane.YES_OPTION)
			{
				int res1=JOptionPane.showConfirmDialog(null,"Are You Sure To Cancel Spectacles Entry?");
...
try
					...
					String query="delete * from customer_SpectsProvidation where srno="+serialno+"";
					inf.executeUpdateQuery(query);
		...
		{
			System.out.println("Error in cancelEntry method of EditProvideSpectsEntryToCustomer class...."+e);
		}
	}
  ...
  //  PanelOfProvideSpectsToCustomer ppp;
    String patientid;
...
try
        		    	...
        		    	recNo=inf.getMaxValue("select max(srno) from customer_SpectsProvidation");
        		    	recNo+=1;
        		    	String ttt[]=getTitle().split("To");
        		    	String title[]=ttt[1].split("#");
        		    	opdNo=Integer.parseInt(title[0].trim());
        		    	name=title[1];
        		    	String str11[]=inf.getResultSetAs_1D_Array("select cName from customer_SpectsProvidation where cID='"+Cid+"'");
        		    	if(str11!=null)
        		    	{
        		    		name=str11[0];
        		    	//	gender=str11[0][1];
