...
{	
	...
	{
		System.out.println("this file is executing..............")	;
			...
			if(name.equals("All"))
			{
				for(int l=0;l<pid.length;l++)
				{
					if(pid[l]!=null)
					{
						...
						date=str[0];
						count=0;
						String set_date=date.trim()+"/"+month+"/"+year;
						...
						String qry="select sum(total_amount) from receivingPatient_FeeDetail where patientID="+Integer.parseInt(pid[l])+" and (visit_dt>=#"+hdate1+"# or visit_dt<=#"+hdate2+"#)";
						System.out.println("qry...."+qry);
						String amt=inf.getSingleValue(qry);
						System.out.println("amt........SCHK..."+amt);
