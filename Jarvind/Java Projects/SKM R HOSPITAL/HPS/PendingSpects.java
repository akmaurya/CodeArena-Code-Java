...
public class PendingSpects implements ActionListener,KeyListener
{
	JLabel jl1,jl2;
	...
	public PendingSpects(JDesktopPane desk)
	{
		...
		String head[]={"S.No.","PID","Name","Surgeon","Lens No","Total Amount","Due Amount"};
