...
public class MakingSaleByHPS extends javax.swing.JInternalFrame {
    ...
    public MakingSaleByHPS(javax.swing.JDesktopPane jDesktopPane1) {
        ...
        try
            ...
            String arr=inf.getSingleValue("select id from admit_Patient_Info where bedNo="+bedNo+" and status=true");
            if(arr!=null)
            {
            	int patientID=Integer.parseInt(arr);
            	arr=inf.getSingleValue("select name from patient_Profile where patientid="+patientID);
...
catch(Exception e)
{
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/forward.gif")));
...
try
            ...
            String stockQ=inf.getSingleValue("select qty from stockHolding_HPS where itemCode="+itemCode+" and batchNo='"+jTextField3.getText()+"'");
            if(stockQ!=null)
		...
		System.out.println("Error with connection with server  rmi://127.0.0.1/ExtendZedServer...");
         ...
         try
               ...
               // ZedInterfaceForMedical uc1=(ZedInterfaceForMedical)Naming.lookup(getIPaddress.IP());
                ZedInterfaceForMedical uc1=null;

try
{
	uc1=(ZedInterfaceForMedical)Naming.lookup(getIPaddress.IP());
