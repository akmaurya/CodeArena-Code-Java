 ...
 * @author  Deep Pal
 */
public class PurchaseDateWiseReportOfSpects extends javax.swing.JInternalFrame {
    
    /** Creates new form ListOfPurchaseing */
    public PurchaseDateWiseReportOfSpects(javax.swing.JDesktopPane jDesktopPane1) {
        initComponents();
...
catch(Exception e)
{
	...
	catch(Exception ex)
	{
        ...
        else
        {
            ...
            ShowIndividualPurchaseBillOfSpects emp=new ShowIndividualPurchaseBillOfSpects(jDesktopPane1,pno,"purchaseSmryOfSpects");
        }
        }
        catch(Exception ex)
		{
