...
public class StaffDetailsById implements ActionListener,KeyListener
{
	...
	{
		jtf=new JInternalFrame("Staff:Promotion Report",false,true,false,true);
		...
		String head[]={"S.N.","Name","Address","Contact No","Designation","Salary","Salary Basis"};
	...
	private void showButton()
	{
		...
		{	
			...
			if(flag)
			{
				...
				if(count>0)
				{
					arr=inf.getResultSetAs_2D_Array("select s_Name,s_Ads,s_Contact,s_Designation,s_Salary,s_SalaryBasis from staff_Details where s_Code="+code,6);	
					...
					arr=inf.getResultSetAs_2D_Array("select s_Name,s_Ads,s_Contact,s_Designation,s_Salary,s_SalaryBasis from staff_DetailsEdit where s_Code="+code,6);
					if(arr!=null)
					{
