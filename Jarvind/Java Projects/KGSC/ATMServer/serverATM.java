...
public class serverATM extends UnicastRemoteObject implements interfaceATM
{
	...
	public boolean updateKGSGInUBI(String data)
		...
		try
		{
			...
			for(int r=0;r<arr.length;r++)
			{
				...
				//System.out.println("db="+debitamt);
				creditamt=arr[r].substring(93,114).trim();	//get credit amt
				//System.out.println("cr="+creditamt);
	...
	public boolean updateUBIBillOfKGSGCards(String data)
		...
		try
		{
			...
			String arr[]=data.split("\n");
			System.out.println(dbamt+""+cramt+"...."+arr.length);
			//System.out.println(".....arr[0]=>"+arr[0]);
			int idx1=-1,idx2=-1;
			for(int r=0;r<arr.length;r++)
			{
				idx1=arr[r].indexOf("|");
				String str1=arr[r].substring(0,idx1); 	//b.date
				
				idx2=arr[r].indexOf("|",idx1+1);
				String str2=arr[r].substring(idx1+1,idx2); 	//card no
				idx1=idx2;
				
				idx2=arr[r].indexOf("|",idx1+1);
				String str3=arr[r].substring(idx1+1,idx2); 	//trace no.
				idx1=idx2;
				
				idx2=arr[r].indexOf("|",idx1+1);
				String str4=arr[r].substring(idx1+1,idx2); 	//trace no.
				idx1=idx2;
				
				idx2=arr[r].indexOf("|",idx1+1);
				String str5=arr[r].substring(idx1+1,idx2); 	//trace no.
				idx1=idx2;
				
				idx2=arr[r].indexOf("|",idx1+1);
				String str6=arr[r].substring(idx1+1,idx2); 	//trace no.
				idx1=idx2;
				
				idx2=arr[r].indexOf("|",idx1+1);
				String str7=arr[r].substring(idx1+1,idx2); 	//trace no.
				idx1=idx2;
				
				idx2=arr[r].indexOf("|",idx1+1);
				String str8=arr[r].substring(idx1+1,idx2); 	//trace no.
				idx1=idx2;
				
				
				//System.out.println("a[7]=>"+str1);
				//System.out.println("a[7]=>"+str2);
				//System.out.println("a[7]=>"+str3);
				
				
				particulars=str2+"/"+str3+"/"+str4;
				//System.out.println("db  particulars="+particulars);
				trandate=str5;//get tran date
				if(str7.equals("C"))
				{
					creditamt=str8;   //get credit amt
					//System.out.println("cr="+creditamt);
				}
				else if(str7.equals("D"))
				{
					debitamt=str8;//get debit amt
					//System.out.println("db  debitamt="+debitamt);
				}
				
				
				
				/*String spl[]=arr[0].split("\|");
				System.out.println("length=>"+spl.length);	
			//	System.out.println("arr[0]="+arr[0]);
				trandate="";particulars="";debitamt="";creditamt="";
				//for(int i=0;i<a.length;i++)
					System.out.println("a[0]=>"+spl[0]);
					System.out.println("a[1]="+spl[1]);
					System.out.println("a[2]="+spl[2]);
					System.out.println("a[3]="+spl[3]);
					System.out.println("a[4]="+spl[4]);
					System.out.println("a[5]="+spl[5]);
					System.out.println("a[6]="+spl[6]);
					System.out.println("a[7]=>"+spl[7]);
					*/
				/*trandate=a[4];//get tran date
				System.out.println("dt  trandate ="+trandate);
				//get particulars
				System.out.println("part  particulars ="+particulars);
				if(a[6]=="C")
				{
					creditamt=a[7];//get credit amt
					System.out.println("cr="+creditamt);
				}
				else if(a[6]=="D")
				{
					debitamt=a[7];//get debit amt
					System.out.println("db  debitamt="+debitamt);
				}*/

				/*trandate=arr[r].substring(1,arr[r].indexOf(" ",1)).trim();	//get tran date
				//System.out.println("dt="+trandate);
				tranid=arr[r].substring(11,arr[r].indexOf(" ",14)).trim();	//get tran id
				//System.out.println("id="+tranid);
				particulars=arr[r].substring(35,60).trim();			//get particulars
				//System.out.println("part="+particulars);
				debitamt=arr[r].substring(60,81).trim();			//get debit amt
				//System.out.println("db="+debitamt);
				creditamt=arr[r].substring(81,104).trim();			//get credit amt
				//System.out.println("cr="+creditamt);
				...
				*/
				...
				//else
				//	status=0;
				System.out.println("insert into ubi_bill_of_kgsg_cards values("+max_entry_no+",'"+trandate+"','"+particulars+"',"+dbamt+","+cramt+","+status+","+paymentno+")");
				st.executeUpdate("insert into ubi_bill_of_kgsg_cards values("+max_entry_no+",'"+trandate+"','"+particulars+"',"+dbamt+","+cramt+","+status+","+paymentno+")");
				max_entry_no++;			
			}
		}
		catch(Exception ex)
		...
		try
		{
			...
			for(int r=0;r<arr.length;r++)
			{
                            ...
                            if(str2.split("                  ").length==2)
                            {
                                ...
                                balamt=str[1].trim();
                                System.out.println(str[0].trim()+"                  length="+str.length+"   "+str[1].trim());
                            }
				...
				st.executeUpdate("insert into ubi_account_statement values("+max_entry_no+",'"+trandate+"','"+particulars+"',"+dbamt+","+cramt+","+balanceamt+","+status+","+paymentno+")");
